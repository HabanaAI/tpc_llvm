...
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %cmp25 = icmp slt i32 %mul, %mul2
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 1 for instruction: br i1 %cmp25, label %for.body.preheader, label %for.cond.cleanup
...
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %d.027 = phi i32 [ %add3, %for.body ], [ %mul, %for.body.preheader ]
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %ifmCoords.026 = phi <5 x i32> [ %vecins, %for.body ], [ zeroinitializer, %for.body.preheader ]
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %2 = tail call <64 x i32> @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %ifmCoords.026, i8 0, i32 0, <64 x i32> undef, i1 true, i1 false)
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %add3 = add nsw i32 %d.027, 128
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %vecins = insertelement <5 x i32> %ifmCoords.026, i32 %add3, i32 1
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %3 = tail call <64 x i32> @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %vecins, i8 1, i32 0, <64 x i32> undef, i1 true, i1 false)
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 4 for instruction: %4 = tail call <64 x i32> @llvm.tpc.add.v64i32.v64i32.v64i32.i1(<64 x i32> %2, <64 x i32> %3, i8 2, i32 1, <64 x i32> undef, i1 true, i1 false)
; LATENCY-NEXT:  Cost Model: Found an estimated cost of 2 for instruction: tail call void @llvm.tpc.st.tnsr.v64i32(<5 x i32> %vecins, i8 2, <64 x i32> %4, i32 0, i1 true, i1 false)
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %d.027 = phi i32 [ %add3, %for.body ], [ %mul, %for.body.preheader ]
  %ifmCoords.026 = phi <5 x i32> [ %vecins, %for.body ], [ zeroinitializer, %for.body.preheader ]
  %2 = tail call <64 x i32> @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %ifmCoords.026, i8 0, i32 0, <64 x i32> undef, i1 true, i1 false)
  %add3 = add nsw i32 %d.027, 128
  %vecins = insertelement <5 x i32> %ifmCoords.026, i32 %add3, i32 1
  %3 = tail call <64 x i32> @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %vecins, i8 1, i32 0, <64 x i32> undef, i1 true, i1 false)
  %4 = tail call <64 x i32> @llvm.tpc.add.v64i32.v64i32.v64i32.i1(<64 x i32> %2, <64 x i32> %3, i8 2, i32 1, <64 x i32> undef, i1 true, i1 false)
  tail call void @llvm.tpc.st.tnsr.v64i32(<5 x i32> %vecins, i8 2, <64 x i32> %4, i32 0, i1 true, i1 false)
...
!1 = !{!"clang version 7.0.0 (ssh://gerrit:29418/tpc_clang2 80a0a209e04a31e8f0eacc32134ef0a097b5a0c3) (ssh://gerrit:29418/tpc_llvm2 2aa0f4faa675dbb2fb92ba2831109e264addcfbb)"}
!2 = !{i32 0}
!3 = distinct !{!3, !4}
