...
; EPILOG-SAME: distinct !{!0, !1, !2}
; EPILOG: !1 = !{!"llvm.loop.unroll.disable"}
; EPILOG: !2 = !{!"llvm.loop.unroll.remainderloop.marker", i32 0}

; PROLOG-SAME: distinct !{!0, !1, !2}
; PROLOG: !1 = !{!"llvm.loop.unroll.disable"}
; PROLOG: !2 = !{!"llvm.loop.unroll.remainderloop.marker", i32 0}
