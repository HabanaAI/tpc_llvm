...
; CHECK-NEXT:    [[TMP2:%.*]] = insertelement <5 x i32> [[VECINS]], i32 [[MUL]], i32 3
; CHECK-NEXT:    br label [[FOR_BODY8:%.*]]
; CHECK:       for.cond.cleanup7.loopexit:
; CHECK-NEXT:    [[VECINS9_LCSSA:%.*]] = phi <5 x i32> [ [[TMP6:%.*]], [[FOR_BODY8]] ]
; CHECK-NEXT:    [[TMP3:%.*]] = call <5 x i32> @llvm.tpc.add.mask.v5i32.i32(<5 x i32> [[VECINS9_LCSSA]], i32 -1, i32 8, i8 2, i32 0, <5 x i32> [[VECINS9_LCSSA]], i1 true, i1 false)
; CHECK-NEXT:    br label [[FOR_COND_CLEANUP7]]
; CHECK:       for.cond.cleanup7:
; CHECK-NEXT:    [[IFMCOORDS_1_LCSSA]] = phi <5 x i32> [ [[VECINS]], [[FOR_BODY]] ], [ [[TMP3]], [[FOR_COND_CLEANUP7_LOOPEXIT:%.*]] ]
...
; CHECK-NEXT:    [[IFMCOORDS_140:%.*]] = phi <5 x i32> [ [[TMP2]], [[FOR_BODY8_PREHEADER]] ], [ [[TMP6]], [[FOR_BODY8]] ]
; CHECK-NEXT:    [[TMP4:%.*]] = tail call <64 x float> @llvm.tpc.ld.tnsr.v64f32.i1(<5 x i32> [[IFMCOORDS_140]], i8 0, i32 0, <64 x float> undef, i1 true, i1 false)
; CHECK-NEXT:    [[TMP5:%.*]] = tail call <64 x float> @llvm.fabs.v64f32(<64 x float> [[TMP4]])
; CHECK-NEXT:    tail call void @llvm.tpc.st.tnsr.v64f32(<5 x i32> [[IFMCOORDS_140]], i8 1, <64 x float> [[TMP5]], i32 0, i1 true, i1 false)
; CHECK-NEXT:    [[TMP6]] = call <5 x i32> @llvm.tpc.add.mask.v5i32.i32(<5 x i32> [[IFMCOORDS_140]], i32 1, i32 8, i8 2, i32 0, <5 x i32> [[IFMCOORDS_140]], i1 true, i1 false)
...
for.body8:                                        ; preds = %for.body8.preheader, %for.body8
  ...
  %2 = tail call <64 x float> @llvm.tpc.ld.tnsr.v64f32.i1(<5 x i32> %vecins9, i8 0, i32 0, <64 x float> undef, i1 true, i1 false)
