...
; CHECK: convert.f32 all_lanes target_type=f16 [[SRC:%V[0-9]+]]
; CHECK-NOT: convert.f32 all_lanes target_type=f16
; CHECK: pack.f16 source_group=0 element_stride=2 [[TMP:%V[0-9]+]], [[SRC]]
; CHECK: pack.f16 source_group=1 element_stride=2 [[TMP]], [[SRC]]

; CHECK: mov_dg src=1 dst=0 wr_lg=0x0 wr_ug=0x1 [[DST:%V[0-9]+]], [[TMP]], 0xb
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %5 = fptrunc <128 x float> %4 to <128 x half>
  tail call void @llvm.tpc.st.tnsr.v128f16(<5 x i32> %vecins, i8 2, <128 x half> %5, i32 0, i1 true, i1 false)
...
!1 = !{!"clang version 7.0.0 (ssh://kshaik@gerrit.habana-labs.com:29418/tpc_clang2.git f8db2bf692c43550c8b7d3f6f25aabcdfdb4198c) (ssh://kshaik@gerrit.habana-labs.com:29418/tpc_llvm2.git 04e6be4b19590deeaffaf54545e749975257c295)"}
!2 = !{i32 0}
!3 = !{i32 256}
