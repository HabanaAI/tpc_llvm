...
; RUN: llc -O1 -march=tpc -mcpu=goya2 %s -o - | FileCheck %s
...
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:  {
; CHECK-NEXT:    cache_invalidate
; CHECK-NEXT:    mov.i16 %V{{[0-9]+}}, 0x0
; CHECK-NEXT:    mov.i16 %V{{[0-9]+}}, 0x0
; CHECK-NEXT:  }
; CHECK-NEXT:  {
; CHECK-NEXT:    mov.i16 %V{{[0-9]+}}, 0x0
; CHECK-NEXT:    mov.i16 %V{{[0-9]+}}, 0x0
; CHECK-NEXT:  }
; CHECK-NEXT:    ld_l_v %V{{[0-9]+}}, 0x100
; CHECK-NEXT:    ld_l_v %V{{[0-9]+}}, 0x0
; CHECK-NEXT:    NOP
; CHECK-NEXT:    NOP
; CHECK-NEXT:    mov_g g_en=0b11 dg_en=0b1111 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    mov_dg all sdg0=0 sdg1=2 sdg2=1 sdg3=3 weg0=3 weg1=2 weg2=1 weg3=3 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    mov_g g_en=0b11 dg_en=0b1111 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    mov_dg all sdg0=0 sdg1=2 sdg2=1 sdg3=3 weg0=3 weg1=2 weg2=1 weg3=3 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    nop
; CHECK-NEXT:    mov_dg all sdg0=2 sdg1=0 sdg2=3 sdg3=1 weg0=2 weg1=1 weg2=2 weg3=1 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    nop
; CHECK-NEXT:    mov_dg all sdg0=2 sdg1=0 sdg2=3 sdg3=1 weg0=2 weg1=1 weg2=2 weg3=1 %V{{[0-9]+}}, %V{{[0-9]+}}, -0x1
; CHECK-NEXT:    NOP
; CHECK-NEXT:    NOP
; CHECK-NEXT:    NOP
; CHECK-NEXT:    unpack.u16 source_group=1 element_stride=2 group_half=0 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    unpack.u16 source_group=0 element_stride=2 group_half=0 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    unpack.u16 source_group=1 element_stride=2 group_half=0 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    unpack.u16 source_group=0 element_stride=2 group_half=0 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    NOP
; CHECK-NEXT:    convert.u16 all_lanes target_type=uint32 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    convert.u16 all_lanes target_type=uint32 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    convert.u16 all_lanes target_type=uint32 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    convert.u16 all_lanes target_type=uint32 %V{{[0-9]+}}, %V{{[0-9]+}}
; CHECK-NEXT:    and.u32 %V{{[0-9]+}}, %V{{[0-9]+}}, 0xffff
; CHECK-NEXT:    and.u32 %V{{[0-9]+}}, %V{{[0-9]+}}, 0xffff
; CHECK-NEXT:    and.u32 %V{{[0-9]+}}, %V{{[0-9]+}}, 0xffff
; CHECK-NEXT:    and.u32 %V0, %V{{[0-9]+}}, 0xffff
; CHECK-NEXT:    st_l_v 0x700, %V{{[0-9]+}}
; CHECK-NEXT:    st_l_v 0x600, %V{{[0-9]+}}
; CHECK-NEXT:    st_l_v 0x500, %V{{[0-9]+}}
; CHECK-NEXT:    st_l_v 0x400, %V{{[0-9]+}}
; CHECK-NEXT:  {
; CHECK-NEXT:    halt
; CHECK-NEXT:    halt
; CHECK-NEXT:  }
...
; CHECK-NEXT:    NOP
; CHECK-NEXT:    NOP
; CHECK-NEXT:  $func_end0:
; CHECK-NEXT:    .size main, ($func_end0)-main
entry:
  ; prepare input
