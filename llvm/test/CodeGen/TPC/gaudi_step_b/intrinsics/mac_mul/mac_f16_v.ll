...
; CHECK: ld_tnsr  [[V2:%V[0-9]+]], 0x1, [[I2]]
; CHECK: mac.f16  [[V0:%V[0-9]+]], [[V1]], [[V2]]
; CHECK: st_tnsr  0x2, [[I2]], [[V0]]
; CHECK: halt
...
entry:
  ...
  %2 = tail call <128 x half> @llvm.tpc.mac.v128f16.v128f16.i1(<128 x half> %0, <128 x half> %1, i8 11, i32 0, <128 x half> zeroinitializer, i1 true, i1 false)
