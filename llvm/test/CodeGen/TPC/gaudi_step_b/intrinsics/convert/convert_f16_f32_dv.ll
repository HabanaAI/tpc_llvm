...
; CHECK: ld_tnsr  %V{{[0-9]+}}, 0x0, [[I2:%I[0-9]+]]
; CHECK: convert.f16 all_lanes target_type=fp32 rhne [[D0:%D[0-9]+]], %V{{[0-9]+}}
; CHECK: st_tnsr  0x1, [[I2]], %V{{[0-9]+}}
; CHECK: st_tnsr  0x1, [[I2]], %V{{[0-9]+}}
; CHECK: halt
...
entry:
  ...
  %1 = tail call <128 x float> @llvm.tpc.convert.v128f32.v128f16.i1(<128 x half> %0, i8 11, i32 0, <128 x float> undef, i1 true, i1 false)
  ...
  tail call void @llvm.tpc.st.tnsr.v64f32(<5 x i32> zeroinitializer, i8 1, <64 x float> %2, i32 0, i1 true, i1 false)
...
; Function Attrs: nounwind readnone
declare <128 x float> @llvm.tpc.convert.v128f32.v128f16.i1(<128 x half>, i8, i32, <128 x float>, i1, i1) #1
