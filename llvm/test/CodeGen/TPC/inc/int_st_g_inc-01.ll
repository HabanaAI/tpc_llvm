...
entry:
  ...
  %1 = call i8 addrspace(3)* @llvm.tpc.st.g.inc.i32(i8 addrspace(3)* %0, i32 %x, i32 4, i32 0, i1 true, i1 false)
  call void @llvm.tpc.st.g.i32(i8 addrspace(3)* %1, i32 %x, i32 0, i1 true, i1 false)
  ret void
}
