...
entry:
  ...
  %dptr.1 = inttoptr i32 %dest to i32 addrspace(1)*
  %loaded.1 = load i32, i32 addrspace(3)* %ptr.1, align 4
  store i32 %loaded.1, i32 addrspace(1)* %dptr.1, align 4

  %uptr.2 = getelementptr inbounds i8, i8 addrspace(3)* %uptr.1, i64 4
  %dptr.2 = getelementptr inbounds i32, i32 addrspace(1)* %dptr.1, i32 1
  %ptr.2 = bitcast i8 addrspace(3)* %uptr.2 to i32 addrspace(3)*
  %loaded.2 = load i32, i32 addrspace(3)* %ptr.2, align 4
  store i32 %loaded.2, i32 addrspace(1)* %dptr.2, align 4

  %uptr.3 = getelementptr inbounds i8, i8 addrspace(3)* %uptr.1, i64 8
  %dptr.3 = getelementptr inbounds i32, i32 addrspace(1)* %dptr.1, i32 2
  %ptr.3 = bitcast i8 addrspace(3)* %uptr.3 to i32 addrspace(3)*
  %loaded.3 = load i32, i32 addrspace(3)* %ptr.3, align 4
  store i32 %loaded.3, i32 addrspace(1)* %dptr.3, align 4
  ret void
}
