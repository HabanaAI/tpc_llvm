...
%struct._uint8_t_pair_t = type { i8, i8 }

; Function Attrs: nounwind
define dso_local void @main(i32 %dest, i8 zeroext %dividend, i8 zeroext %divisor) local_unnamed_addr {
entry:
  %0 = inttoptr i32 %dest to %struct._uint8_t_pair_t addrspace(1)*
  %1 = udiv i8 %dividend, %divisor
  %quot_rem.sroa.0.0..sroa_idx = getelementptr inbounds %struct._uint8_t_pair_t, %struct._uint8_t_pair_t addrspace(1)* %0, i32 0, i32 0
