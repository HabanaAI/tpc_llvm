...
; ModuleID = 'fp128xf16tofp128xf32.c'
source_filename = "fp128xf16tofp128xf32.c"
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %2 = tail call <128 x half> @llvm.tpc.ld.tnsr.v128f16.i1(<5 x i32> %vecins, i8 0, i32 7, <128 x half> undef, i1 undef, i1 true)
  %3 = fpext <128 x half> %2 to <128 x float>
...
; Function Attrs: nounwind readnone
declare <128 x float> @llvm.tpc.convert.v128f32.v128f16.v256i1(<128 x half>, i8, i32, <128 x float>, <256 x i1>, i1) #1
