...
entry:
  ...
  %1 = call i1 @llvm.tpc.cmp.eq.i1.f8_143.f8_143.i1(f8_143 %x0, f8_143 2.0, i8 13, i32 0, i1 %res0, i1 %pred, i1 false)
...
declare i1 @llvm.tpc.cmp.eq.i1.f8_143.f8_143.i1(f8_143, f8_143, i8, i32, i1, i1, i1)

; CHECK: mov            [[RES:%SP[0-9]+]], %S1
; CHECK: cmp_eq.f8_143  [[RES]], %S0, 0x40
