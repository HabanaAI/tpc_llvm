...
define void @main(f8_143 %x0, f8_143 %x1, float %res0, i32 %dest, i1 zeroext %pred) {
entry:
  %0 = inttoptr i32 %dest to float addrspace(1)*
  %1 = call float @llvm.tpc.mul.f32.f8_143.i1(f8_143 %x0, f8_143 %x1, i8 13, i32 0, float %res0, i1 %pred, i1 false)
...
; CHECK: mul.f8_143  %S2, %S0, %S1, [[PRED]]
; CHECK: st_l        %S3, %S2
