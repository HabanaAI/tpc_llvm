...
define void @main(i32 %dest, i32 %x0, f8_143 %x1, i32 %income, i32 %pred) {
entry:
  ...
  %5 = call <256 x float> @llvm.tpc.add.v256f32.v256f32.f8_143.v256i1(<256 x float> %1, f8_143 %x1, i8 13, i32 0, <256 x float> %3, <256 x i1> %vpred, i1 false)

  store <256 x float> %5, <256 x float> addrspace(2)* %4, align 256
  ret void
}

declare <256 x float> @llvm.tpc.add.v256f32.v256f32.f8_143.v256i1(<256 x float>, f8_143 %x1, i8, i32, <256 x float>, <256 x i1>, i1)
