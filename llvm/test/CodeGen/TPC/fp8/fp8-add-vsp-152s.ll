...
entry:
  ...
  %5 = call <256 x float> @llvm.tpc.add.v256f32.v256f32.f8_152.i1(<256 x float> %1, f8_152 %x1, i8 12, i32 0, <256 x float> %3, i1 %pred, i1 false)

  store <256 x float> %5, <256 x float> addrspace(2)* %4, align 256
  ret void
}

declare <256 x float> @llvm.tpc.add.v256f32.v256f32.f8_152.i1(<256 x float>, f8_152, i8, i32, <256 x float>, i1, i1)
