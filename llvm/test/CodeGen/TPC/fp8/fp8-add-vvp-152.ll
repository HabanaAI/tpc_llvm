...
entry:
  ...
  %7 = call <256 x float> @llvm.tpc.add.v256f32.v256f32.v256f8_152.i1(<256 x float> %1, <256 x f8_152> %3, i8 12, i32 0, <256 x float> %5, i1 %pred, i1 false)
...
; CHECK:     add.f8_152 %A[[RES]], %A[[X0]], %V[[X1]], [[PRED]]
