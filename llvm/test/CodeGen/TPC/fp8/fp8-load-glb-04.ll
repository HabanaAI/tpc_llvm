...
entry:
  ...
  %1 = tail call f8_152 @llvm.tpc.ld.g.f8_152(i8 addrspace(3)* %0, i32 0, f8_152 0xI00, i1 %pred, i1 false)
  %2 = inttoptr i32 %dest to f8_152 addrspace(1)*
  store f8_152 %1, f8_152 addrspace(1)* %2, align 4
  ret void
}

declare i8 addrspace(3)* @llvm.tpc.gen.addr(<5 x i32>, i8, i32, i8 addrspace(3)*, i1, i1)
declare f8_152 @llvm.tpc.ld.g.f8_152(i8 addrspace(3)*, i32, f8_152, i1, i1)
