...
define void @main(i32 %dest, i32 %x0, i32 %x1, i32 %income, i1 zeroext %pred) {
entry:
  ...
  %7 = call <256 x float> @llvm.tpc.add.v256f32.v256f32.v256f8_143.i1(<256 x float> %1, <256 x f8_143> %3, i8 13, i32 0, <256 x float> %5, i1 %pred, i1 false)

  store <256 x float> %7, <256 x float> addrspace(2)* %6, align 256
  ret void
}

declare <256 x float> @llvm.tpc.add.v256f32.v256f32.v256f8_143.i1(<256 x float>, <256 x f8_143>, i8, i32, <256 x float>, i1, i1)
