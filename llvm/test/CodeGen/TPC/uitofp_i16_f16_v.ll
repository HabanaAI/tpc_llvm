...
entry:
  ...
  %.cast = uitofp <128 x i16> %1 to <128 x half>
  call void @llvm.tpc.st.tnsr.v128f16(<5 x i32> %0, i8 1, <128 x half> %.cast, i32 0, i1 true, i1 false)
  ret void
}
...
; CHECK: convert.u16 lane_sel=0 target_type=f16  %V{{[0-9]+}}, %V{{[0-9]+}}
