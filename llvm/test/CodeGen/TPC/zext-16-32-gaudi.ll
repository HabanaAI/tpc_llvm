...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %3 = zext <128 x i16> %2 to  <128 x i32>
...
; Function Attrs: nounwind readnone
declare <128 x i32> @llvm.tpc.convert.v128i32.v128i16.v256i1(<128 x i16>, i8, i32, <128 x i32>, <256 x i1>, i1) #1
