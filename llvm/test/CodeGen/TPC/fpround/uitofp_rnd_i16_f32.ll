...
; CHECK: convert.u16 target_type=uint32 %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0:%SP[0-9]+]]
; CHECK: convert.u32 target_type=fp32 rz %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0:%SP[0-9]+]]
...
entry:
  ...
  %conv = tail call <128 x float> @llvm.tpc.uitofp.swch.v128f32.v128i16(<128 x i16> %index, i32 65536)
...
declare <128 x float> @llvm.tpc.uitofp.swch.v128f32.v128i16(<128 x i16>, i32)
