...
; RUN: llc < %s -march=tpc -mcpu=gaudi -O1 
...
entry:
  ...
  %conv = tail call <128 x i16> @llvm.tpc.fptosi.swch.v128i16.v128f32(<128 x float> %shufFromTnsr, i32 65536)
  tail call void @llvm.tpc.st.tnsr.v128i16(<5 x i32> %vecins, i8 1, <128 x i16> %conv, i32 0, i1 true, i1 false)
  ret void
}

; Function Attrs: nounwind readnone
declare <128 x i16> @llvm.tpc.fptosi.swch.v128i16.v128f32(<128 x float>, i32)
