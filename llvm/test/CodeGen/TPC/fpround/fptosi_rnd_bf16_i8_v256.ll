; NOTE: Assertions can be autogenerated by utils/update_llc_test_checks.py
; RUN: llc -march=tpc -mcpu=gaudi -O1 %s -o -
; RUN: llc -march=tpc -mcpu=greco -O1 %s -o -
; RUN: llc -march=tpc -mcpu=gaudi -O0 %s -o -
; RUN: llc -march=tpc -mcpu=greco -O0 %s -o -
...
entry:
  ...
  %conv = tail call <256 x i8> @llvm.tpc.fptosi.swch.v256i8.v256bf16(<256 x bfloat16> %shufFromTnsr, i32 0)
  tail call void @llvm.tpc.st.tnsr.v256i8(<5 x i32> %vecins, i8 1, <256 x i8> %conv, i32 0, i1 true, i1 false)
  ret void
}

; Function Attrs: nounwind readnone
declare <256 x i8> @llvm.tpc.fptosi.swch.v256i8.v256bf16(<256 x bfloat16>, i32)
