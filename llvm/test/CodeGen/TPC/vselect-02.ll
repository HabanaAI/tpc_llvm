...
entry:
  ...
  %3 = inttoptr i32 %pred to <64 x i1> addrspace(2)*

  %v1 = load <64 x i32>, <64 x i32> addrspace(2)* %1, align 256
  %v2 = load <64 x i32>, <64 x i32> addrspace(2)* %2, align 256
  %vp = load <64 x i1>, <64 x i1> addrspace(2)* %3, align 256

  %vr = select <64 x i1> %vp, <64 x i32> %v1, <64 x i32> %v2 
...
; CHECK:     mov     [[VAL2]], [[VAL1]], [[PRED]]
; CHECK:     st_l_v  %S0,{{.*}} [[VAL2]]
