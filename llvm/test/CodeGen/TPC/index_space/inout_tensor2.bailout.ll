...
; CHECK-LLVM: .ascii " SCEVBEGIN IndexSpace:[0].[Output].{ GC_CUSTOM, GC_CUSTOM, GC_CUSTOM, GC_CUSTOM, GC_CUSTOM } #SCEVEND"

; CHECK-MLIR: "SCEVCost From TPC Index":
; CHECK-MLIR: .ascii " SCEVBEGIN IndexSpace:[0].[Output].{ 0, 0, 0, 0, 0 } #SCEVEND"
...
bb30:                                             ; preds = %bb30, %bb
  ...
  %0 = insertelement <5 x i32> %ifm, i32 0, i32 0
  tail call void @llvm.tpc.st.tnsr.v64f32(<5 x i32> %ifm, i8 0, <64 x float> zeroinitializer, i32 0, i1 true, i1 false)
  %1 = tail call <64 x float> @llvm.tpc.ld.tnsr.v64f32.i1(<5 x i32> %0, i8 0, i32 0, <64 x float> undef, i1 true, i1 false)
