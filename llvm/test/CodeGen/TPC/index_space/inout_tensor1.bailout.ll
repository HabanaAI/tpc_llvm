...
; CHECK-LLVM: .ascii " SCEVBEGIN IndexSpace:[0].[Input].{ GC_CUSTOM, GC_CUSTOM, GC_CUSTOM, GC_CUSTOM, GC_CUSTOM } #SCEVEND"

; CHECK-MLIR: "SCEVCost From TPC Index":
; CHECK-MLIR: .ascii " SCEVBEGIN IndexSpace:[0].[Input].{ 0, 0, 0, 0, 0 } #SCEVEND"
...
bb30:                                             ; preds = %bb30, %bb
  ...
  tail call void @llvm.tpc.st.tnsr.v64f32(<5 x i32> %ifm, i8 0, <64 x float> %1, i32 0, i1 true, i1 false)
