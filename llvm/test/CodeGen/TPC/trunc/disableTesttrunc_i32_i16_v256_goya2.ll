...
; CHECK: convert.i32 all_lanes target_type=int16  %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
...
; CHECK: pack.i16 source_group=0 element_stride=2 %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
; CHECK: pack.i16 source_group=1 element_stride=2 %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
; CHECK: mov_dg src=1 dst=0 wr_lg=0x0 wr_ug=0x1 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=2 dst=1 wr_lg=0x1 wr_ug=0x0 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=3 dst=1 wr_lg=0x0 wr_ug=0x1 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=0 dst=2 wr_lg=0x1 wr_ug=0x0 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=1 dst=2 wr_lg=0x0 wr_ug=0x1 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=2 dst=3 wr_lg=0x1 wr_ug=0x0 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: mov_dg src=3 dst=3 wr_lg=0x0 wr_ug=0x1 %V{{[0-9]+}}, %V{{[0-9]+}}, 0x7, [[SP0]]
; CHECK: convert.i32 all_lanes target_type=int16  %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
; CHECK: pack.i16 source_group=0 element_stride=2 %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
; CHECK: pack.i16 source_group=1 element_stride=2 %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
; CHECK: convert.i32 all_lanes target_type=int16  %V{{[0-9]+}}, %V{{[0-9]+}}, [[SP0]]
