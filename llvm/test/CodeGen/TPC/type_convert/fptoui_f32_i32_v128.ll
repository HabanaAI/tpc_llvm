...
;
; CHECK: convert.f32 all_lanes target_type=int32  %D[[N:[0-9]+]], %D[[M]]
; CHECK: convert.i32 all_lanes target_type=uint32 rhne %D[[M]], %D[[N]]
;
; CHECK: st_l_v  0x0, %V[[M]]
; CHECK: st_l_v  0x100, %V{{[0-9]+}}
; CHECK: halt
;
; TODO: validate %V[[#M+1]] with a later FileCheck version
...
entry:
  ...
  %1 = fptoui <128 x float> %0 to <128 x i32>
