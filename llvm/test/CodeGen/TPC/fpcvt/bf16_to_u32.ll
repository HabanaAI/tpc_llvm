...
entry:
  ...
  %1 = fptoui bfloat16 %x to i32
  store i32 %1, i32 addrspace(1)* %0, align 4
  ret void
}

; GEN3: convert.bf16 target_type=fp32 rhne [[VAL1:%S[0-9]+]], %S1
; GEN3: convert.f32  target_type=int32 [[VAL2:%S[0-9]+]], [[VAL1]]
; GEN3: convert.i32  target_type=uint32 rhne [[VAL3:%S[0-9]+]], [[VAL2]]
; GEN3: st_l         %S0, [[VAL3]]

; GEN4: convert.bf16 target_type=uint32 [[VAL:%S[0-9]+]], %S1
; GEN4: st_l         %S0, [[VAL]]
