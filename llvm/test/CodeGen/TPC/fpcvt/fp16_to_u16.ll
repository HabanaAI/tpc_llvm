...
entry:
  ...
  %1 = fptoui half %x to i16
  store i16 %1, i16 addrspace(1)* %0, align 4
  ret void
}

; GEN3: convert.f16 target_type=int16 [[VAL1:%S[0-9]+]], %S1
; GEN3: convert.i16 target_type=uint16 [[VAL2:%S[0-9]+]], [[VAL2]]
; GEN3: st_l        %S0, [[VAL2]]

; GEN4: convert.f16 target_type=uint16 [[VAL:%S[0-9]+]], %S1
; GEN4: st_l        %S0, [[VAL]]
