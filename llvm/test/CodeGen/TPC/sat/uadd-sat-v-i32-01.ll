...
entry:
  ...
  %add = call <64 x i32> @llvm.uadd.sat.v64i32(<64 x i32> %x1, <64 x i32> %x2)
  store <64 x i32> %add, <64 x i32> addrspace(2)* %dptr
  ret void
}

declare <64 x i32> @llvm.uadd.sat.v64i32(<64 x i32>, <64 x i32>)

; CHECK: add.u32 st [[DEST:%V[0-9]+]], {{%V[0-9]+}}, {{%V[0-9]+}}
