...
entry:
  ...
  %add = call <256 x i8> @llvm.uadd.sat.v256i8(<256 x i8> %x1, <256 x i8> %x2)
  store <256 x i8> %add, <256 x i8> addrspace(2)* %dptr
  ret void
}

declare <256 x i8> @llvm.uadd.sat.v256i8(<256 x i8>, <256 x i8>)

; CHECK: add.u8  st [[DEST:%V[0-9]+]], {{%V[0-9]+}}, {{%V[0-9]+}}
