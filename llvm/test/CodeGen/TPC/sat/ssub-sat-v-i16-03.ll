...
entry:
  ...
  %sub = call <128 x i16> @llvm.ssub.sat.v64i32(<128 x i16> %x1, <128 x i16> %x2)
  store <128 x i16> %sub, <128 x i16> addrspace(2)* %dptr
  ret void
}

declare <128 x i16> @llvm.ssub.sat.v64i32(<128 x i16>, <128 x i16>)

; CHECK: sub.i16 st [[DEST:%V[0-9]+]], {{%V[0-9]+}}, 0x309
