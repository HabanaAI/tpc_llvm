...
entry:
  ...
  %sub = call <256 x i8> @llvm.usub.sat.v256i8(<256 x i8> %x1, <256 x i8> %x2)
  store <256 x i8> %sub, <256 x i8> addrspace(2)* %dptr
  ret void
}

declare <256 x i8> @llvm.usub.sat.v256i8(<256 x i8>, <256 x i8>)

; CHECK: sub.u8  st [[DEST:%V[0-9]+]], {{%V[0-9]+}}, {{%V[0-9]+}}
