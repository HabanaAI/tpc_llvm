...
entry:
  ...
  %3 = call <256 x float> @llvm.tpc.convert.v256f32.v256i32.i1(<256 x i32> %2, i8 2, i32 0, <256 x float> undef, i1 1, i1 0)
...
; CHECK:     convert.i32 all_lanes target_type=fp32 rhne %A[[ARF:[0-9]+]],  %A[[ARF]]
