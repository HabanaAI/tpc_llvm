...
entry:
  ...
  %2 = tail call < 64 x i32 > @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %0, i8 0, i32 0, < 64 x i32 > undef, i1 true, i1 false)
  %3 = tail call < 64 x i32 > @llvm.tpc.ld.tnsr.v64i32.i1(<5 x i32> %1, i8 0, i32 0, < 64 x i32 > undef, i1 true, i1 false)
  ...
  %6 = call < 128 x i16 > @llvm.tpc.convert.v128i16.v128i32.v256i1(< 128 x i32 > %4, i8 2, i32 1792, < 128 x i16 > undef, < 256 x i1 > %5, i1 false)
...
declare < 128 x i16 > @llvm.tpc.convert.v128i16.v128i32.v256i1(< 128 x i32 >, i8, i32, < 128 x i16 >, < 256 x i1 >, i1)

; GRECO:  convert_int32 all_lanes rhne to_16 [[VRF:%V[0-9]+]], %D{{[0-9]+}}
; GAUDI2: convert.i32 all_lanes target_type=int16 rhne  [[VRF:%V[0-9]+]], %D{{[0-9]+}}, %VP
; DORON1: convert.i32 all_lanes target_type=int16 rhne  [[VRF:%V[0-9]+]], %D{{[0-9]+}}, %VP
