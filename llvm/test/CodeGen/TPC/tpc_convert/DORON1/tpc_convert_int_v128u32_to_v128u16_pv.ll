...
entry:
  ...
  %6 = call < 128 x i16 > @llvm.tpc.convert.uint.v128i16.v128u32.v256i1(< 128 x i32 > %4, i8 3, i32 2048, < 128 x i16 > undef, < 256 x i1 > %5, i1 false)
...
declare < 128 x i16 > @llvm.tpc.convert.uint.v128i16.v128u32.v256i1(< 128 x i32 >, i8, i32, < 128 x i16 >, < 256 x i1 >, i1)


; GRECO:     convert_uint32 all_lanes rhne to_16 [[VRF:%V[0-9]+]], %D{{[0-9]+}}
; GAUDIX:    convert_uint32 all_lanes rhne to_16 [[VRF:%V[0-9]+]], %D{{[0-9]+}}
