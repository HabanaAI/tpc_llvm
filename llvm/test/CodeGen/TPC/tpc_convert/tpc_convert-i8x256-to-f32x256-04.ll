...
entry:
  ...
  %dval = call <256 x float> @llvm.tpc.convert.v256f32.v256i8.i1(<256 x i8> %srcval, i8 4, i32 0, <256 x float> %inval, i1 %spred, i1 0)
...
; CHECK-DAG: ld_l_v      %V{{[0-9]+}}, %S{{[0-9]+}}
; CHECK-DAG: ld_l_v      %V{{[0-9]+}}, %S{{[0-9]+}}
; CHECK:     convert.i8  all_lanes target_type=fp32 rhne %A[[ARF]], [[VRF]], [[SPRF]]
