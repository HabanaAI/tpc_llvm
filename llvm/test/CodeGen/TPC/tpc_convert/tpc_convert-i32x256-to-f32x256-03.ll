...
entry:
  ...
  %dval = call <256 x float> @llvm.tpc.convert.v256f32.v256i32.v256i1(<256 x i32> %srcval, i8 2, i32 0, <256 x float> %inval, <256 x i1> %vpred, i1 0)
...
; CHECK-DAG: ld_l_v      %V[[ARFd:[0-9]+]], %S3
; CHECK:     convert.i32  all_lanes target_type=fp32 rhne %A[[ARFd]],  %A[[ARFs]], [[VPRF]]
