...
entry:
  ...
  %dval = call <256 x f8_152> @llvm.tpc.convert.v256f8_152.v256f8_143.v256i1(<256 x f8_143> %srcval, i8 13, i32 3072, <256 x f8_152> undef, <256 x i1> %vpred, i1 1)
...
; CHECK:     convert.f8_143 all_lanes target_type=f8_152 rhne [[VRF]], [[VRF]], ![[VPRF]]
; CHECK-DAG: st_l_v     %S{{[0-9]+}}, [[VRF]]
