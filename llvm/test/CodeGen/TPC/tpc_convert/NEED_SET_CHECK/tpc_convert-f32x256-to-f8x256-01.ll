...
entry:
  ...
  %1 = inttoptr i32 %dest to <256 x f8_143> addrspace(2)*
  %2 = load <256 x float>, <256 x float> addrspace(2)* %0, align 256
  %3 = call <256 x f8_143> @llvm.tpc.convert.v256f8_143.v256f32.i1(<256 x float> %2, i8 0, i32 3328, <256 x f8_143> undef, i1 1, i1 0)
  store <256 x f8_143> %3, <256 x f8_143> addrspace(2)* %1, align 256
  ret void
}
