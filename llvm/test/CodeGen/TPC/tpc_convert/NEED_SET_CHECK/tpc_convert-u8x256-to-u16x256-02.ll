...
entry:
  ...
  %dval = call <256 x i16> @llvm.tpc.convert.v256i16.v256i8.v256i1(<256 x i8> %srcval, i8 5, i32 2048, <256 x i16> undef, <256 x i1> %vpred, i1 1)
...
; GRECO:     convert.u8 all_lanes target_type=uint16 rhne %D[[DRF:[0-9]+]], [[VRF]], ![[VPRF]]
