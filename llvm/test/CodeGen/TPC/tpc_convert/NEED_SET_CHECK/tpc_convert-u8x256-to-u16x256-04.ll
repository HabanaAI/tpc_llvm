...
entry:
  ...
  %dval = call <256 x i16> @llvm.tpc.convert.v256i16.v256i8.i1(<256 x i8> %srcval, i8 5, i32 2048, <256 x i16> %inval, i1 %spred, i1 0)
...
; CHECK-DAG: ld_l_v      %V[[DRF:[0-9]+]], %S2
; GRECO:     convert.u8  all_lanes target_type=uint16 rhne %D[[DRF]], [[VRF]], [[SPRF]]
