...
entry:
  ...
  %dval = call <256 x i32> @llvm.tpc.convert.v256i16.v256i8.i1(<256 x i8> %srcval, i8 4, i32 512, <256 x i32> %inval, i1 %spred, i1 0)
...
; GRECO:     convert.i8 all_lanes target_type=int32 rhne %A[[ARF:[0-9]+]], [[VRF]]
