...
entry:
  ...
  %dval = call <256 x i16> @llvm.tpc.convert.v256i16.v256i8.v256i1(<256 x i8> %srcval, i8 5, i32 2048, <256 x i16> %inval, <256 x i1> %vpred, i1 0)
...
; CHECK-DAG: ld_l_v     %V[[DRF:[0-9]+]], %S3
; GRECO:     convert.u8 all_lanes target_type=uint16 rhne %D[[DRF]], [[VRF]], [[VPRF]]
