...
entry:
  ...
  %dval = call <256 x f8_152> @llvm.tpc.convert.v256f8_152.v256f32.v256i1(<256 x float> %srcval, i8 0, i32 3072, <256 x f8_152> undef, <256 x i1> %vpred, i1 1)
  store <256 x f8_152> %dval, <256 x f8_152> addrspace(2)* %dptr, align 256
  ret void
}

declare <256 x f8_152> @llvm.tpc.convert.v256f8_152.v256f32.v256i1(<256 x float>, i8, i32, <256 x f8_152>, <256 x i1>, i1)
