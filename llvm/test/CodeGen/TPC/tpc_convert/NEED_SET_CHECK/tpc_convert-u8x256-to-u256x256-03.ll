...
entry:
  ...
  %dval = call <256 x i32> @llvm.tpc.convert.v256i16.v256i8.v256i1(<256 x i8> %srcval, i8 5, i32 768, <256 x i32> %inval, <256 x i1> %vpred, i1 0)
...
; GRECO:     convert.u8 all_lanes target_type=uint32 rhne %A[[ARF]], [[VRF]], [[VPRF]]
