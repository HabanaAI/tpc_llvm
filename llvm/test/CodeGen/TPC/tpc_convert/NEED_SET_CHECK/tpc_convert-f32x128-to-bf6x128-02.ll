...
entry:
  ...
  %dval = call <128 x bfloat16> @llvm.tpc.convert.v128bf16.v128f32.v256i1(<128 x float> %srcval, i8 0, i32 256, <128 x bfloat16> undef, <256 x i1> %vpred, i1 1)
  store <128 x bfloat16> %dval, <128 x bfloat16> addrspace(2)* %dptr, align 256
  ret void
}

declare <128 x bfloat16> @llvm.tpc.convert.v128bf16.v128f32.v256i1(<128 x float>, i8, i32, <128 x bfloat16>, <256 x i1>, i1)
