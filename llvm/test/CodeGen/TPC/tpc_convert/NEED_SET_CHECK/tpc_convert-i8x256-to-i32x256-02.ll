...
entry:
  ...
  %dval = call <256 x i32> @llvm.tpc.convert.v256i16.v256i8.v256i1(<256 x i8> %srcval, i8 4, i32 512, <256 x i32> undef, <256 x i1> %vpred, i1 1)
...
; GRECO:     convert.i8 all_lanes target_type=int32 rhne %A[[ARF:[0-9]+]], [[VRF]], ![[VPRF]]
