...
; UN: llc -mcpu gaudib %s -o - 
; UN: llc -mcpu gaudi %s -o -  
; UN: llc -mcpu goya %s -o -   
...
entry:
  ...
  %dval = call <256 x i8> @llvm.tpc.convert.v256i8.v256i16.v256i1(<256 x i16> %srcval, i8 7, i32 1024, <256 x i8> undef, <256 x i1> %vpred, i1 1)
  store <256 x i8> %dval, <256 x i8> addrspace(2)* %dptr, align 256
  ret void
}

declare <256 x i8> @llvm.tpc.convert.v256i8.v256i16.v256i1(<256 x i16>, i8, i32, <256 x i8>, <256 x i1>, i1)
