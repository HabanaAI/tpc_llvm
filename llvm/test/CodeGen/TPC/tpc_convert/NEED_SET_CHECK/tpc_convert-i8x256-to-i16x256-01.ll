...
entry:
  ...
  %3 = call <256 x i16> @llvm.tpc.convert.v256i16.v256i8.i1(<256 x i8> %2, i8 4, i32 1792, <256 x i16> undef, i1 1, i1 0)
...
; GRECO:     convert.i8 all_lanes target_type=int16 rhne %D[[ARF:[0-9]+]], [[VRF]]
