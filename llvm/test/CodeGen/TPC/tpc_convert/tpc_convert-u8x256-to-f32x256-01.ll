...
entry:
  ...
  %3 = call <256 x float> @llvm.tpc.convert.v256f32.v256i8.i1(<256 x i8> %2, i8 5, i32 0, <256 x float> undef, i1 1, i1 0)
...
; CHECK:     convert.u8 all_lanes target_type=fp32 rhne %A[[ARF:[0-9]+]], [[VRF]]
