...
entry:
  ...
  %dval = call <256 x float> @llvm.tpc.convert.v256f32.v256i8.v256i1(<256 x i8> %srcval, i8 5, i32 0, <256 x float> %inval, <256 x i1> %vpred, i1 0)
...
; CHECK-DAG: ld_l_v     %V{{[0-9]+}}, %S{{[0-9]+}}
; CHECK-DAG: ld_l_v     %V{{[0-9]+}}, %S{{[0-9]+}}
; CHECK:     convert.u8 all_lanes target_type=fp32 rhne %A[[ARF]], [[VRF]], [[VPRF]]
