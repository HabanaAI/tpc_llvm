...
Type *Type::getPrimitiveType(LLVMContext &C, TypeID IDNumber) {
  ...
  case F8_143ID      : return getF8_143Ty(C);
  case F8_152ID      : return getF8_152Ty(C);
  case BFloat16ID    : return getBFloat16Ty(C);
#endif
  default:
    return nullptr;
  }
...
TypeSize Type::getPrimitiveSizeInBits() const {
  switch (getTypeID()) {
#ifdef LLVM_TPC_COMPILER
  case Type::F8_143ID: return TypeSize::Fixed(8);
  case Type::F8_152ID: return TypeSize::Fixed(8);
  case Type::BFloat16ID: return TypeSize::Fixed(16);
#endif
...
#ifdef LLVM_TPC_COMPILER
  if (getTypeID() == F8_143ID) return 4;
  if (getTypeID() == F8_152ID) return 3;
  if (getTypeID() == BFloat16ID) return 8;
#endif
...
#ifdef LLVM_TPC_COMPILER
Type *Type::getBFloat16Ty(LLVMContext &C) { return &C.pImpl->BFloat16Ty; }
Type *Type::getF8_143Ty(LLVMContext &C) { return &C.pImpl->F8_143Ty; }
Type *Type::getF8_152Ty(LLVMContext &C) { return &C.pImpl->F8_152Ty; }
#endif
