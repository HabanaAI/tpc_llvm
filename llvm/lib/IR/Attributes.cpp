...
std::string Attribute::getAsString(bool InAttrGrp) const {
  ...
  if (hasAttribute(Attribute::IndexSpace))
    return "index_space";
  if (hasAttribute(Attribute::IndexSpaceb))
    return "index_space_b";
  if (hasAttribute(Attribute::ReductionOrNormAxes))
    return "reduction_or_norm_axes";
  if (hasAttribute(Attribute::UnrollInfo))
    return "unroll_info";
#endif
