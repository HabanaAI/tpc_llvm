...
Type *EVT::getTypeForEVT(LLVMContext &Context) const {
...
#ifdef LLVM_TPC_COMPILER
  case MVT::bf16:     return Type::getBFloat16Ty(Context);
  case MVT::v128bf16: return VectorType::get(Type::getBFloat16Ty(Context), 128);
  case MVT::v256bf16: return VectorType::get(Type::getBFloat16Ty(Context), 256);
  ...
  case MVT::v256f8_143:    return VectorType::get(Type::getF8_143Ty(Context), 256);
  case MVT::v512f8_143:    return VectorType::get(Type::getF8_143Ty(Context), 512);
  case MVT::v1024f8_143:   return VectorType::get(Type::getF8_143Ty(Context), 1024);
  case MVT::f8_152:    return Type::getF8_152Ty(Context);
  case MVT::v256f8_152:    return VectorType::get(Type::getF8_152Ty(Context), 256);
  case MVT::v512f8_152:    return VectorType::get(Type::getF8_152Ty(Context), 512);
  case MVT::v1024f8_152:   return VectorType::get(Type::getF8_152Ty(Context), 1024);
#endif
  }
}
...
#ifdef LLVM_TPC_COMPILER
  case Type::BFloat16ID:   return MVT(MVT::bf16);
  case Type::F8_143ID:     return MVT(MVT::f8_143);
  case Type::F8_152ID:     return MVT(MVT::f8_152);
#endif
