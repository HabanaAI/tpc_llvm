...
std::string EVT::getEVTString() const {
  ...
  case MVT::v128bf16: return "v128bf16";
  case MVT::v256bf16: return "v256bf16";
  case MVT::f8_143:   return "f8_143";
  case MVT::v256f8_143:  return "v256f8_143";
  case MVT::v512f8_143:  return "v512f8_143";
  case MVT::v1024f8_143: return "v1024f8_143";
  case MVT::f8_152:   return "f8_152";
  case MVT::v256f8_152:  return "v256f8_152";
  case MVT::v512f8_152:  return "v512f8_152";
  case MVT::v1024f8_152: return "v1024f8_152";
#endif
  }
}
...
#ifdef LLVM_TPC_COMPILER
  case MVT::v256i16:     return FixedVectorType::get(Type::getInt16Ty(Context), 256);
  case MVT::v512i16:     return FixedVectorType::get(Type::getInt16Ty(Context), 512);
  case MVT::v512i8:      return FixedVectorType::get(Type::getInt8Ty(Context), 512);
  case MVT::v256bf16:    return FixedVectorType::get(Type::getBFloatTy(Context), 256);
  case MVT::v256f16:     return FixedVectorType::get(Type::getHalfTy(Context), 256);
  case MVT::f8_143:      return Type::getF8_143Ty(Context);
  case MVT::v256f8_143:  return FixedVectorType::get(Type::getF8_143Ty(Context), 256);
  case MVT::v512f8_143:  return FixedVectorType::get(Type::getF8_143Ty(Context), 512);
  case MVT::v1024f8_143: return FixedVectorType::get(Type::getF8_143Ty(Context), 1024);
  case MVT::f8_152:      return Type::getF8_152Ty(Context);
  case MVT::v256f8_152:  return FixedVectorType::get(Type::getF8_152Ty(Context), 256);
  case MVT::v512f8_152:  return FixedVectorType::get(Type::getF8_152Ty(Context), 512);
  case MVT::v1024f8_152: return FixedVectorType::get(Type::getF8_152Ty(Context), 1024);
#endif
  }
}
...
#ifdef LLVM_TPC_COMPILER
  case Type::F8_143TyID:    return MVT(MVT::f8_143);
  case Type::F8_152TyID:    return MVT(MVT::f8_152);
#endif
