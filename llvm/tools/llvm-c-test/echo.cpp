...
struct TypeCloner {
  ...
  LLVMTypeRef Clone(LLVMTypeRef Src) {
    ...
    switch (Kind) {
      ...
      case LLVMBFloat16TypeKind:
        return LLVMBFloat16TypeInContext(Ctx);
      case LLVMF8_152TypeKind:
        return LLVMF8_152TypeInContext(Ctx);
      case LLVMF8_143TypeKind:
        return LLVMF8_143TypeInContext(Ctx);
#endif
