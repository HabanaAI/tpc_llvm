const llvm::StringRef Goya2ReduceMinF16LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <128 x half> @v_f16_reduce_min(<128 x half> %x) local_unnamed_addr #4 {
entry:
  ...
  %12 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %x, <128 x half> %11, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  ...
  %14 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %12, <128 x half> %13, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %15 = call <128 x half> @llvm.tpc.mov.group.v128f16.v128f16.i1(<128 x half> %14, i32 -1, i32 63, <128 x half> %13, i1 true, i1 false)
  %16 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %14, <128 x half> %15, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %17 = call <128 x half> @llvm.tpc.shuffle.v128f16.i1(<128 x half> %16, <256 x i8> %7, i8 11, i32 0, <128 x half> %15, i1 true, i1 false)
  %18 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %16, <128 x half> %17, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %19 = call <128 x half> @llvm.tpc.shuffle.v128f16.i1(<128 x half> %18, <256 x i8> %8, i8 11, i32 0, <128 x half> %17, i1 true, i1 false)
  %20 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %18, <128 x half> %19, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %21 = call <128 x half> @llvm.tpc.shuffle.v128f16.i1(<128 x half> %20, <256 x i8> %9, i8 11, i32 0, <128 x half> %19, i1 true, i1 false)
  %22 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %20, <128 x half> %21, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %23 = call <128 x half> @llvm.tpc.shuffle.v128f16.i1(<128 x half> %22, <256 x i8> %10, i8 11, i32 0, <128 x half> %21, i1 true, i1 false)
  %24 = call <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half> %22, <128 x half> %23, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  ret <128 x half> %24
}
...
declare <128 x half> @llvm.tpc.min.v128f16.v128f16.v128f16.i1(<128 x half>, <128 x half>, i8, i32, <128 x half>, i1, i1) #1
