const llvm::StringRef Gaudi2SqrtF16LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <128 x half> @sqrt_f16(<128 x half> %input) local_unnamed_addr #2 {
entry:
  ...
  %4 = call <256 x i16> @llvm.tpc.get.lut.entry.v256i16.v128f16.i1(<128 x half> %3, i8 8, i8 11, i32 16384, <256 x i16> undef, i1 true, i1 false)
  ...
  %9 = call <128 x half> @llvm.tpc.lookup.1c.v128f16.v128i16(<128 x i16> %5, i32 393, i32 17, <128 x half> zeroinitializer, i1 true, i1 false)
  %10 = call <256 x half> @llvm.tpc.lookup.2c.v256f16.v128i16(<128 x i16> %5, i32 386, i32 17, <256 x half> zeroinitializer, i1 true, i1 false)
  ...
  %add = add <128 x i16> %shl, %14
  %15 = bitcast <128 x i16> %add to <128 x half>
  %16 = call <128 x half> @llvm.tpc.fclass.v128f16.i1(<128 x half> %input, i8 11, i32 0, <128 x half> undef, i1 true, i1 false)
  %17 = call <128 x half> @llvm.tpc.calc.fp.special.v128f16.i1(<128 x half> %16, <128 x half> undef, i8 11, i32 2, <128 x half> %15, i1 true, i1 false)
  ret <128 x half> %17
}
...
attributes #0 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "min-legal-vector-width"="2048" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="gaudi2" "target-features"="+gaudi2" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #1 = { nounwind readnone }
attributes #2 = { alwaysinline nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "min-legal-vector-width"="2048" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="gaudi2" "target-features"="+gaudi2" "unsafe-fp-math"="false" "use-soft-float"="false" }
