...
//
//===----------------------------------------------------------------------===//
const llvm::StringRef GaudiReduceMinBF16LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <128 x bfloat16> @v_bf16_reduce_min(<128 x bfloat16> %x) local_unnamed_addr #4 {
entry:
  ...
  %12 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %x, <128 x bfloat16> %11, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %14 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %12, <128 x bfloat16> %13, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %16 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %14, <128 x bfloat16> %15, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %18 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %16, <128 x bfloat16> %17, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %20 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %18, <128 x bfloat16> %19, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %22 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %20, <128 x bfloat16> %21, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
  ...
  %24 = call <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16> %22, <128 x bfloat16> %23, i8 1, i32 0, <128 x bfloat16> undef, i1 true, i1 false)
...
declare <128 x bfloat16> @llvm.tpc.min.v128bf16.v128bf16.v128bf16.i1(<128 x bfloat16>, <128 x bfloat16>, i8, i32, <128 x bfloat16>, i1, i1) #1
