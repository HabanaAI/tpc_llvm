const llvm::StringRef GaudiSqrtF32LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <64 x float> @sqrt_f32(<64 x float> %input) local_unnamed_addr #2 {
entry:
  ...
  %3 = call <128 x i32> @llvm.tpc.get.lut.entry.v128i32.v64f32.i1(<64 x float> %2, i8 17, i8 0, i32 16384, <128 x i32> undef, i1 true, i1 false) #4
  ...
  %7 = call <64 x float> @llvm.tpc.lookup.1c.v64f32.v64i32(<64 x i32> %4, i32 128, i32 0, <64 x float> undef, i1 true, i1 false) #4
  %8 = call <128 x float> @llvm.tpc.lookup.2c.v128f32.v64i32(<64 x i32> %4, i32 128, i32 0, <128 x float> undef, i1 true, i1 false) #4
  ...
  %add.i = add <64 x i32> %shl.i, %13
  %15 = bitcast <64 x i32> %add.i to <64 x float>
  %16 = call <64 x float> @llvm.tpc.sel.eq.v64f32.v64f32.f32.v64f32.v64f32.i1(<64 x float> %input, float 0.000000e+00, <64 x float> zeroinitializer, <64 x float> %15, i8 0, i32 0, <64 x float> undef, i1 true, i1 false) #4
  %17 = call <64 x float> @llvm.tpc.fclass.v64f32.i1(<64 x float> %input, i8 0, i32 0, <64 x float> undef, i1 true, i1 false)
  %18 = call <64 x float> @llvm.tpc.calc.fp.special.v64f32.i1(<64 x float> %17, <64 x float> undef, i8 0, i32 2, <64 x float> %16, i1 true, i1 false)
  ret <64 x float> %18
}
