...
define  dso_local <256 x i8> @v_u8_reduce_max(<256 x i8> %0) local_unnamed_addr #2 {
  ...
  %23 = call <256 x i8> @llvm.tpc.max.v256i8.v256i8.v256i8.i1(<256 x i8> %21, <256 x i8> %22, i8 5, i32 0, <256 x i8> undef, i1 true, i1 false)
  %24 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %23, <256 x i8> %12, i8 5, i32 0, <256 x i8> %22, i1 true, i1 false)
  %25 = call <256 x i8> @llvm.tpc.max.v256i8.v256i8.v256i8.i1(<256 x i8> %23, <256 x i8> %24, i8 5, i32 0, <256 x i8> undef, i1 true, i1 false)
  %26 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %25, <256 x i8> %13, i8 5, i32 0, <256 x i8> %24, i1 true, i1 false)
  %27 = call <256 x i8> @llvm.tpc.max.v256i8.v256i8.v256i8.i1(<256 x i8> %25, <256 x i8> %26, i8 5, i32 0, <256 x i8> undef, i1 true, i1 false)
  %28 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %27, <256 x i8> %14, i8 5, i32 0, <256 x i8> %26, i1 true, i1 false)
  %29 = call <256 x i8> @llvm.tpc.max.v256i8.v256i8.v256i8.i1(<256 x i8> %27, <256 x i8> %28, i8 5, i32 0, <256 x i8> undef, i1 true, i1 false)
  %30 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %29, <256 x i8> %15, i8 5, i32 0, <256 x i8> %28, i1 true, i1 false)
  %31 = call <256 x i8> @llvm.tpc.max.v256i8.v256i8.v256i8.i1(<256 x i8> %29, <256 x i8> %30, i8 5, i32 0, <256 x i8> undef, i1 true, i1 false)
  ret <256 x i8> %31
}
