const llvm::StringRef GaudiReduceMinF32LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <64 x float> @v_f32_reduce_min(<64 x float> %x) local_unnamed_addr #4 {
entry:
  ...
  %9 = call <64 x float> @llvm.minnum.v64f32(<64 x float> %x, <64 x float> %8)
...
declare <64 x float> @llvm.minnum.v64f32(<64 x float>, <64 x float>) #4
