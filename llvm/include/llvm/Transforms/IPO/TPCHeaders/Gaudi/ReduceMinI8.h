const llvm::StringRef GaudiReduceMinI8LL = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <256 x i8> @v_i8_reduce_min(<256 x i8> %0) local_unnamed_addr #2 {
  ...
  %17 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %0, <256 x i8> %16, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %18 = call <256 x i8> @llvm.tpc.mov.dual.group.all.v256i8.i1(<256 x i8> %17, i32 -1, i32 0, i32 16731648, <256 x i8> %16, i1 true, i1 false)
  %19 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %17, <256 x i8> %18, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %20 = call <256 x i8> @llvm.tpc.mov.group.v256i8.v256i8.i1(<256 x i8> %19, i32 -1, i32 63, <256 x i8> %18, i1 true, i1 false)
  %21 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %19, <256 x i8> %20, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %22 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %21, <256 x i8> %11, i8 4, i32 0, <256 x i8> %20, i1 true, i1 false)
  %23 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %21, <256 x i8> %22, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %24 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %23, <256 x i8> %12, i8 4, i32 0, <256 x i8> %22, i1 true, i1 false)
  %25 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %23, <256 x i8> %24, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %26 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %25, <256 x i8> %13, i8 4, i32 0, <256 x i8> %24, i1 true, i1 false)
  %27 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %25, <256 x i8> %26, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %28 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %27, <256 x i8> %14, i8 4, i32 0, <256 x i8> %26, i1 true, i1 false)
  %29 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %27, <256 x i8> %28, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  %30 = call <256 x i8> @llvm.tpc.shuffle.v256i8.i1(<256 x i8> %29, <256 x i8> %15, i8 4, i32 0, <256 x i8> %28, i1 true, i1 false)
  %31 = call <256 x i8> @llvm.tpc.min.v256i8.v256i8.v256i8.i1(<256 x i8> %29, <256 x i8> %30, i8 4, i32 0, <256 x i8> undef, i1 true, i1 false)
  ret <256 x i8> %31
}
