const llvm::StringRef Gaudi_ReduceAddF32 = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <64 x float> @v_f32_reduce_add(<64 x float> %x) local_unnamed_addr #5 {
entry:
...
const llvm::StringRef Gaudi2_ReduceAddF32 = R"(
; Function Attrs: alwaysinline nounwind
define  dso_local <64 x float> @v_f32_reduce_add(<64 x float> %x) local_unnamed_addr #5 {
entry:
  %0 = call <64 x i32> @llvm.read_register.v64i32(metadata !0)
