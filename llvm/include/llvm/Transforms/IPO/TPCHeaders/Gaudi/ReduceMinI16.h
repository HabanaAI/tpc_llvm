...
define  dso_local <128 x i16> @v_i16_reduce_min(<128 x i16> %0) local_unnamed_addr #2 {
  ...
  %21 = call <128 x i16> @llvm.tpc.min.v128i16.v128i16.v128i16.i1(<128 x i16> %19, <128 x i16> %20, i8 7, i32 0, <128 x i16> undef, i1 true, i1 false)
  %22 = call <128 x i16> @llvm.tpc.shuffle.v128i16.i1(<128 x i16> %21, <256 x i8> %11, i8 7, i32 0, <128 x i16> %20, i1 true, i1 false)
  %23 = call <128 x i16> @llvm.tpc.min.v128i16.v128i16.v128i16.i1(<128 x i16> %21, <128 x i16> %22, i8 7, i32 0, <128 x i16> undef, i1 true, i1 false)
  %24 = call <128 x i16> @llvm.tpc.shuffle.v128i16.i1(<128 x i16> %23, <256 x i8> %12, i8 7, i32 0, <128 x i16> %22, i1 true, i1 false)
  %25 = call <128 x i16> @llvm.tpc.min.v128i16.v128i16.v128i16.i1(<128 x i16> %23, <128 x i16> %24, i8 7, i32 0, <128 x i16> undef, i1 true, i1 false)
  %26 = call <128 x i16> @llvm.tpc.shuffle.v128i16.i1(<128 x i16> %25, <256 x i8> %13, i8 7, i32 0, <128 x i16> %24, i1 true, i1 false)
  %27 = call <128 x i16> @llvm.tpc.min.v128i16.v128i16.v128i16.i1(<128 x i16> %25, <128 x i16> %26, i8 7, i32 0, <128 x i16> undef, i1 true, i1 false)
  ret <128 x i16> %27
}
