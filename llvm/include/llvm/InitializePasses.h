...
void initializeCoordUpdateSimplifyPass(PassRegistry &);
...
void initializeLinkTPCHeadersLegacyPassPass(PassRegistry &);
...
void initializeIterationInterleaveLegacyPass(PassRegistry&);
...
void initializeLoopTakenPass(PassRegistry &);
void initializeLoopUnrollPass(PassRegistry&);
void initializeLoopSWPPass(PassRegistry &);
...
void initializeTPCReplaceCmpSelPassPass(PassRegistry &);
void initializeTPCLicmPassPass(PassRegistry &);
...
void initializeEliminateSwizzleCastLegacyPassPass(PassRegistry &);
