...
#ifdef LLVM_TPC_COMPILER
  static const fltSemantics &Float8_143() LLVM_READNONE;
  static const fltSemantics &Float8_152() LLVM_READNONE;
  static const fltSemantics &BFloat16() LLVM_READNONE;
#endif
...
#ifdef LLVM_TPC_COMPILER
  APInt convertFloat8_143APFloatToAPInt() const;
  APInt convertFloat8_152APFloatToAPInt() const;
  APInt convertBFloat16APFloatToAPInt() const;
#endif
...
#ifdef LLVM_TPC_COMPILER
  void initFromFloat8_143APInt(const APInt &api);
  void initFromFloat8_152APInt(const APInt &api);
  void initFromBFloat16APInt(const APInt &api);
#endif
