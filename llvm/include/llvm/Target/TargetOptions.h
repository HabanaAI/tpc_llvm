...
namespace llvm {
  ...
  public:
    ...
    /// Maximal scalar local memory.
    unsigned LocalScalarMemory = 1024;

    /// Maximal vector local memory.
    unsigned LocalVectorMemory = 80 * 1024;
    unsigned SpillVlm = 0;

    bool AllLoopsTaken = false;
    bool RegMemCount = false;
    bool LutWarn = true;
    bool CompressInstructions = true;
    bool LongIRF = false;
    bool TpcDnorm = false;

    unsigned MaxTensor = 0;
