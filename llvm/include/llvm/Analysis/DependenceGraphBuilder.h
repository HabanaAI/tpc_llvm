...
protected:
  ...
  /// Create the exit node of the graph.
  virtual NodeType &createExitNode() = 0;
  ...
  /// Create a use-def edge going from \p Src to \p Tgt.
  virtual EdgeType &createUseDefEdge(NodeType &Src, NodeType &Tgt) = 0;
