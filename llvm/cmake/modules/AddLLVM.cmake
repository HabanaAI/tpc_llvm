...
function(configure_lit_site_cfg site_in site_out)
  ...
  if (EXISTS "${ARG_MAIN_CONFIG}")
    string(REPLACE "${LLVM_SOURCE_DIR}" "%(llvm_src)s" MAP_CONFIG_TMP "${ARG_MAIN_CONFIG}")
    string(REPLACE "${CLANG_SOURCE_DIR}" "%(clang_src)s" MAP_CONFIG_IN "${MAP_CONFIG_TMP}")
    string(REPLACE "${LLVM_BINARY_DIR}" "%(llvm_build)s" MAP_CONFIG_OUT "${site_out}")
    set(PYTHON_STATEMENT "map_config('${MAP_CONFIG_IN}' % builtin_parameters, '${MAP_CONFIG_OUT}' % builtin_parameters)")
