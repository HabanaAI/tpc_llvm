...
static Attr *handleLoopHintAttr(Sema &S, Stmt *St, const ParsedAttr &A,
  ...
  StringRef PragmaName =
      llvm::StringSwitch<StringRef>(PragmaNameLoc->Ident->getName())
          ...
          .Cases("loop_unroll", "loop_unroll_divide", "loop_taken",
                 "loop_pipeline", PragmaNameLoc->Ident->getName())
#endif
          .Default("clang loop");

#ifdef LLVM_TPC_COMPILER
  bool PragmaLoopUnroll = PragmaNameLoc->Ident->getName() == "loop_unroll";
  bool PragmaLoopUnrollDivide = PragmaNameLoc->Ident->getName() == "loop_unroll_divide";
  bool PragmaLoopTaken = PragmaNameLoc->Ident->getName() == "loop_taken";
  bool PragmaLoopPipeline = PragmaNameLoc->Ident->getName() == "loop_pipeline";
  if (PragmaLoopUnroll || PragmaLoopUnrollDivide) {
    if (St->getStmtClass() != Stmt::ForStmtClass) {
      const char *Pragma =
        llvm::StringSwitch<const char *>(PragmaNameLoc->Ident->getName())
        .Case("loop_unroll", "#pragma loop_unroll")
        .Case("loop_unroll_divide", "#pragma loop_unroll_divide")
        .Default("#pragma clang loop");
      S.Diag(St->getBeginLoc(), diag::err_pragma_loop_precedes_nonforloop) << Pragma;
      return nullptr;
    }
  }
#endif
...
#ifdef LLVM_TPC_COMPILER
  } else if (PragmaLoopUnroll) {
    assert(ValueExpr);
    // #pragma loop_unroll N
    Option = LoopHintAttr::MachineUnrollCount;
    State = LoopHintAttr::Numeric;
    SetHints(LoopHintAttr::MachineUnrollCount, LoopHintAttr::Numeric);
  } else if (PragmaLoopUnrollDivide) {
    assert(ValueExpr);
    // #pragma loop_unroll_divide N
    Option = LoopHintAttr::MachineUnrollCount;
    State = LoopHintAttr::Numeric;
    SetHints(LoopHintAttr::MachineUnrollCount, LoopHintAttr::Numeric);
  } else if (PragmaLoopTaken) {
    // #pragma loop_taken
    Option = LoopHintAttr::Taken;
    State = LoopHintAttr::Enable;
    SetHints(LoopHintAttr::Taken, LoopHintAttr::Enable);
  } else if (PragmaLoopPipeline) {
    // #pragma loop_pipeline
    Option = LoopHintAttr::LoopPipeline;
    State = LoopHintAttr::Enable;
    SetHints(LoopHintAttr::LoopPipeline, LoopHintAttr::Enable);
#endif
  } else {
    // #pragma clang loop ...
...
#ifdef LLVM_TPC_COMPILER
                 .Case("machine_unroll_count", LoopHintAttr::MachineUnrollCount)
                 .Case("divide", LoopHintAttr::Divide)
                 .Case("taken", LoopHintAttr::Taken)
                 .Case("pipelined", LoopHintAttr::Pipelined)
                 .Case("unaligned_trip_count", LoopHintAttr::UnalignedTripCount)
#endif
...
#ifdef LLVM_TPC_COMPILER
               Option == LoopHintAttr::Divide ||
               Option == LoopHintAttr::Taken ||
               Option == LoopHintAttr::Pipelined ||
               Option == LoopHintAttr::UnalignedTripCount ||
#endif
...
CheckForIncompatibleAttributes(Sema &S,
  ...
  for (const auto *I : Attrs) {
    ...
    if (Option == LoopHintAttr::Vectorize ||
        ...
        Option == LoopHintAttr::PipelineDisabled ||
#ifdef LLVM_TPC_COMPILER
        Option == LoopHintAttr::Divide || Option == LoopHintAttr::Taken ||
        Option == LoopHintAttr::Pipelined ||
        Option == LoopHintAttr::UnalignedTripCount ||
        Option == LoopHintAttr::LoopPipeline ||
#endif
