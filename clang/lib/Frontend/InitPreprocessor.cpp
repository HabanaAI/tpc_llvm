...
#undef TOSTR2
  ...
  if (TI.getTriple().getArch() == llvm::Triple::tpc) {
    Builder.defineMacro("__HABANA_TOOL_VERSION", getTPCToolChain());
    Builder.defineMacro("__TPC_DROP_VERSION", getTPCDropVersion());
    Builder.defineMacro("VERSION2DEC(a,b,c) ((a << 16) + (b << 8) + c)","");
  }
#endif
