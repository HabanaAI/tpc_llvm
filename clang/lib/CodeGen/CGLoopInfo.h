...
struct LoopAttributes {
  ...
  /// \brief Do not generate prolog/epilog.
  LVEnableState SkipRemainder = Unspecified;

  /// \brief Do not generate bypass jump.
  LVEnableState Taken = Unspecified;

  /// \brief Unroll count.
  unsigned MachineUnrollCount = 0;

  LVEnableState Pipelined = Unspecified;

  LVEnableState UnalignedTripCount = Unspecified;

  /// \brief Enable IR Loop Pipelining
  LVEnableState LoopPipeline = Unspecified;
#endif
...
#ifdef LLVM_TPC_COMPILER
  /// \brief Skip unroll remainder of the next pushed loop.
  void setSkipRemainder(bool Enable) {
    StagedAttrs.SkipRemainder = Enable ? LoopAttributes::Enable
                                       : LoopAttributes::Disable;
  }

  void setTaken(bool Enable) {
    StagedAttrs.Taken = Enable ? LoopAttributes::Enable
                               : LoopAttributes::Disable;
  }

  void setPipelined(bool Enable) {
    StagedAttrs.Pipelined = Enable ? LoopAttributes::Enable
                                   : LoopAttributes::Disable;
  }

  void setUnalignedTripCount(bool Enable) {
    StagedAttrs.UnalignedTripCount =
        Enable ? LoopAttributes::Enable : LoopAttributes::Disable;
  }

  void setLoopPipeline(bool Enable) {
    StagedAttrs.LoopPipeline =
        Enable ? LoopAttributes::Enable : LoopAttributes::Disable;
  }

  void setMachineUnrollCount(unsigned C) { StagedAttrs.MachineUnrollCount = C; }
#endif
