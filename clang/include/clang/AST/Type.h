...
public:
  ...
  bool isFloat8Type() const;
  bool isF8_143Type() const;
  bool isF8_152Type() const;
#endif
...
#ifdef LLVM_TPC_COMPILER
inline bool Type::isFloat8Type() const {
  return isSpecificBuiltinType(BuiltinType::Float8_143) ||
         isSpecificBuiltinType(BuiltinType::Float8_152);
}

inline bool Type::isF8_143Type() const {
  return isSpecificBuiltinType(BuiltinType::Float8_143);
}

inline bool Type::isF8_152Type() const {
  return isSpecificBuiltinType(BuiltinType::Float8_152);
}
#endif
