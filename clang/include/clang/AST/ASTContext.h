...
private:
  ...
  /// Tensor used for printf.
  unsigned int TensorForPrintf;

  /// True, if compiled program contains printf call.
  bool PrintfIsUsed = false;

public:

  unsigned int getPrintfTensor() const {
    return TensorForPrintf;
  }

  void setPrintfTensor(unsigned I) {
    TensorForPrintf = I;
  }

  bool isPrintfIsUsed() const {
    return PrintfIsUsed;
  }

  void setPrintfIsUsed() {
    PrintfIsUsed = true;
  }

  // Specific TPC types support.
  //----------------------------
...
public:
  ...
  enum class TpcType {
    ...
    char256_uchar256,
    char256_minifloat256,
    char256_minihalf256,
    uchar256_char256,
    uchar256_minifloat256,
    uchar256_minihalf256,
    ...
    minifloat512,
    minifloat256_minihalf256,
    minifloat256_char256,
    minifloat256_uchar256,

    minihalf512,
    minihalf256_minifloat256,
    minihalf256_char256,
    minihalf256_uchar256
  };

  const TypeDecl *getTpcTypeDecl(TpcType T) const;
  QualType getTpcType(TpcType T) const;
  const TypeDecl *getTpcRecordDecl(unsigned R) const;

  void loadTpcTypes() const;
#endif
...
public:
  ...
  CanQualType Float8_143Ty;
  CanQualType Float8_152Ty;
#endif
...
#ifdef LLVM_TPC_COMPILER
bool isInTPCVectorAddressSpace(QualType T);
#endif
} // namespace clang
