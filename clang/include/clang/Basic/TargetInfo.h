...
struct TransferrableTargetInfo {
  ...
  unsigned char Float8Width, Float8Align;
#endif
...
#ifdef LLVM_TPC_COMPILER
  const llvm::fltSemantics *Float8_143Format;
  const llvm::fltSemantics *Float8_152Format;
...
#ifdef LLVM_TPC_COMPILER
  unsigned getFloat8Width() const { return Float8Width; }
  unsigned getFloat8Align() const { return Float8Align; }
  const llvm::fltSemantics &getFloat8_143Format() const { return *Float8_143Format; }
  const llvm::fltSemantics &getFloat8_152Format() const { return *Float8_152Format; }
