...
public:
  ...
  /// Maximal local scalar memory (TPC)
  unsigned ScalarLocalMemory;

  /// Maximal local vector memory (TPC)
  unsigned VectorLocalMemory;

  /// Maximal local vector memory for spills (TPC)
  unsigned SpillVlm;

  bool MarkAsUsingPrintf = false;
