...
void main(unsigned dest, char value, _Bool pred){
  s_i8_st_l(dest, value, 0, pred, 1);
  s_i8_st_l(0x100, value, 1, pred, 0);
#if defined(__goya2__)
  s_i8_st_l(dest+4, value, 3, pred, 1);
  s_i8_st_l(0x200, value, 3, pred, 0);
#endif
}
