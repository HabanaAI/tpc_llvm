...
void main(unsigned dest, unsigned value){
  s_u32_st_l(dest, value, 0, 1, 0);
  s_u32_st_l(0x100, value, 1, 1, 0);
#if defined(__goya2__)
  s_u32_st_l(dest+4, value, 3, 1, 0);
  s_u32_st_l(0x200, value, 3, 1, 0);
#endif
}
