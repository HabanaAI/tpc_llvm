...
// CHECK: nop;    nop;    form_fp_num.bf16  V1, V2, V3, V4, SP0;  nop
...
// CHECK: nop;    nop;    form_fp_num.bf16  V2, S1, V3, V4, SP0;  nop
...
// CHECK: nop;    nop;    form_fp_num.bf16  V2, 0x3f80, V3, V4, SP0;  nop
...
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias V1, V2, V3, V4, SP0;     nop
...
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias force_sign0 exp_is_num V1, V2, V3, V4, SP0;      nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias force_sign1 exp_is_num V1, V2, V3, V4, SP0;      nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias exp_is_num sign_lsb V1, V2, V3, V4, SP0;         nop
// CHECK: nop;    nop;    form_fp_num.bf16  force_sign0 exp_is_num V1, V2, V3, V4, SP0;   nop
// CHECK: nop;    nop;    form_fp_num.bf16  force_sign1 exp_is_num V1, V2, V3, V4, SP0;   nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_is_num sign_lsb V1, V2, V3, V4, SP0;      nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias force_sign0 V1, V2, V3, V4, SP0;         nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias force_sign1 V1, V2, V3, V4, SP0;         nop
// CHECK: nop;    nop;    form_fp_num.bf16  exp_add_bias sign_lsb V1, V2, V3, V4, SP0;    nop
// CHECK: nop;    nop;    form_fp_num.bf16  force_sign0 V1, V2, V3, V4, SP0;      nop
// CHECK: nop;    nop;    form_fp_num.bf16  force_sign1 V1, V2, V3, V4, SP0;      nop
// CHECK: nop;    nop;    form_fp_num.bf16  sign_lsb V1, V2, V3, V4, SP0;         nop
