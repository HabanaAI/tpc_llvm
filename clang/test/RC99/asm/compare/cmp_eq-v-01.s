...
// CHECK: nop; 	nop; 	cmp_eq.f32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.f32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.f32  VP1, V2, 0x3f4ccccd, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8  VP1, V2, 0x7b, SP0; 	nop
