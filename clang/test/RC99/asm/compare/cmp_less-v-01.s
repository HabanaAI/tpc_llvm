...
// CHECK: nop; 	nop; 	cmp_less.f32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.f32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.f32  VP1, V2, 0x3f4ccccd, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i32  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u32  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u32  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u32  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i16  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i16  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i16  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u16  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u16  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u16  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i8  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i8  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.i8  VP1, V2, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u8  VP1, V2, V3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u8  VP1, V2, S3, SP0; 	nop
...
// CHECK: nop; 	nop; 	cmp_less.u8  VP1, V2, 0x7b, SP0; 	nop
