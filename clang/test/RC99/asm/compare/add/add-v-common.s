...
// CHECK: nop;    nop;    add.i32  V3, V2, V1, SP0;       nop
...
// CHECK: nop;    nop;    add.u8  V3, V2, 0xea, SP0;      nop
// CHECK: nop;    nop;    add.f32  V3, V2, 0x40100000, SP0;       nop
...
// CHECK: nop;    nop;    add.i32  V3, V2, S1, SP0;       nop
...
// CHECK: nop;    nop;    add.i32  st V3, V2, V1, SP0;    nop
...
// CHECK: nop;    nop;    add.i32  st V3, V2, 0x4d2, SP0;         nop
...
// CHECK: nop;    nop;    add.i32  st V3, V2, S1, SP0;    nop
