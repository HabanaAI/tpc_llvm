...
// CHECK: nop;    nop;    max.f32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    max.f32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    max.f32  V5, V1, 0x3f4ccccd;       nop
...
// CHECK: nop;    nop;    max.i32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    max.i32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    max.i32  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    max.u32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    max.u32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    max.u32  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    max.i16  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    max.i16  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    max.i16  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    max.u16  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    max.u16  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    max.u16  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    max.i8  V5, V1, V2;        nop
...
// CHECK: nop;    nop;    max.i8  V5, V1, S2;        nop
...
// CHECK: nop;    nop;    max.i8  V5, V1, 0x7b;      nop
...
// CHECK: nop;    nop;    max.u8  V5, V1, V2;        nop
...
// CHECK: nop;    nop;    max.u8  V5, V1, S2;        nop
...
// CHECK: nop;    nop;    max.u8  V5, V1, 0x7b;      nop
