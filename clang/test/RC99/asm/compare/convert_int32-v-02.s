...
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rhne to_8 V6, V12, V8, SP0;        nop
...
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rhne to_8 V6, V12, V8, SP0;         nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rhne to_8 V6, V12, V8, SP0;         nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rz to_8 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rd to_8 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 ru to_8 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 sr to_8 V6, V12, V8, SP0;   nop
...
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rhne to_8 V6, V12, V8, SP0;        nop
// CHECK: nop;    nop;    convert_int32 lane_sel=1 rhne to_8 V6, V12, V8, SP0;        nop
// CHECK: nop;    nop;    convert_int32 lane_sel=2 rd to_8 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=3 ru to_8 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 sr to_8 V6, V12, V8, SP0;   nop
...
// CHECK: nop;    nop;    convert_int32 lane_sel=0 rhne to_16 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=1 rhne to_16 V6, V12, V8, SP0;   nop
// CHECK: nop;    nop;    convert_int32 lane_sel=2 rd to_16 V6, V12, V8, SP0;     nop
// CHECK: nop;    nop;    convert_int32 lane_sel=3 ru to_16 V6, V12, V8, SP0;     nop
// CHECK: nop;    nop;    convert_int32 lane_sel=0 sr to_16 V6, V12, V8, SP0;     nop
