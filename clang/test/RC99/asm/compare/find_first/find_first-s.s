...
// CHECK: nop; 	find_first.f32 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.f32 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.f32  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.f32 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.f32  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.i32 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i32 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i32  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i32 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i32  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.u32 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u32 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u32  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u32 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u32  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.i16 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i16 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i16  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i16 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i16  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.u16 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u16 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u16  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u16 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u16  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.i8 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i8 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i8  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.i8 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.i8  set=1 start_msb S1, S2, SP0; 	nop; 	nop
...
// CHECK: nop; 	find_first.u8 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u8 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u8  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.u8 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.u8  set=1 start_msb S1, S2, SP0; 	nop; 	nop
