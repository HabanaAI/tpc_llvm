...
// CHECK: nop; 	find_first.bf16 set=0 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.bf16 set=0 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16 set=0 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16  set=1 start_lsb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.bf16  set=1 start_lsb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16  set=1 start_lsb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16 set=0 start_msb S1, S2, SP0; 	nop; 	nop
// CHECK: nop; 	find_first.bf16 set=0 start_msb S1, S2, SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16 set=0 start_msb S1, S2, !SP3; 	nop; 	nop
// CHECK: nop; 	find_first.bf16  set=1 start_msb S1, S2, SP0; 	nop; 	nop
