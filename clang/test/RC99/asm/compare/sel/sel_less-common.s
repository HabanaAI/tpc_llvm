...
// CHECK: nop; nop; sel_less.i32 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i32 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i32 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i32 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.i32 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.i16 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i16 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i16 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i16 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.i16 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.i8 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i8 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i8 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.i8 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.i8 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.u32 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u32 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u32 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u32 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.u32 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.u16 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u16 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u16 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u16 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.u16 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.u8 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u8 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u8 V4, V5, 0x7a, V7, V8; nop
...
// CHECK: nop; nop; sel_less.u8 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.u8 V4, V5, V6, V7, 0x7b; nop
...
// CHECK: nop; nop; sel_less.f32 V4, V5, V6, V7, V8; nop
...
// CHECK: nop; nop; sel_less.f32 V4, V5, S3, V7, V8; nop
...
// CHECK: nop; nop; sel_less.f32 V4, V5, 0x3f800000, V7, V8; nop
...
// CHECK: nop; nop; sel_less.f32 V4, V5, V6, V7, S3; nop
...
// CHECK: nop; nop; sel_less.f32 V4, V5, V6, V7, 0x3f800000; nop
