...
//CHECK: nop; nop; sub.f32 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.f32 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.f32 V5, V1, 0x42e00000; nop
...
//CHECK: nop; nop; sub.i32 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i32 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i32 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.i16 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i16 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i16 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.i8 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i8 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i8 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u32 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u32 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u32 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u16 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u16 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u16 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u8 V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u8 V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u8 V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.f32 neg V5, V1, V2; nop
...
//CHECK: nop; nop; sub.f32 neg V5, V1, S2; nop
...
//CHECK: nop; nop; sub.f32 neg V5, V1, 0x42e00000; nop
...
//CHECK: nop; nop; sub.i32 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i32 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i32 st V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.i16 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i16 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i16 st V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.i8 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.i8 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.i8 st V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u32 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u32 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u32 st V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u16 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u16 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u16 st V5, V1, 0x70; nop
...
//CHECK: nop; nop; sub.u8 st V5, V1, V2; nop
...
//CHECK: nop; nop; sub.u8 st V5, V1, S2; nop
...
//CHECK: nop; nop; sub.u8 st V5, V1, 0x70; nop
