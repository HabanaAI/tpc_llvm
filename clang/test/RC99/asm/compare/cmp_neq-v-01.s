...
// CHECK: nop; 	nop; 	cmp_neq.f32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.f32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.f32  VP1, V2, 0x3f4ccccd; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.i8  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_neq.u8  VP1, V2, 0x7b; 	nop
