...
// CHECK: nop;    cmp_neq.f32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_neq.f32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_neq.f32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_neq.f32  SP1, S2, 0x3f4ccccd, SP0;   nop;    nop
...
// CHECK: nop;    cmp_neq.i32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_neq.i32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_neq.i32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_neq.i32  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_neq.u32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_neq.u32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_neq.u32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_neq.u32  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_neq.i16  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_neq.i16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_neq.i16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_neq.i16  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_neq.u16  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_neq.u16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_neq.u16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_neq.u16  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_neq.i8  SP1, S2, S3, SP0;    nop;    nop
// CHECK: nop;    cmp_neq.i8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_neq.i8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_neq.i8  SP1, S2, 0x7b, SP0;  nop;    nop
...
// CHECK: nop;    cmp_neq.u8  SP1, S2, S3, SP0;    nop;    nop
// CHECK: nop;    cmp_neq.u8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_neq.u8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_neq.u8  SP1, S2, 0x7b, SP0;  nop;    nop
