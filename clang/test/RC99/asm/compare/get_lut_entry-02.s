...
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x1;    nop
...
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x0;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x1;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x2;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x3;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0xc;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0xd;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0xe;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0xf;    nop
...
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  D4, V2, 0x4;        nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  tanh D4, V2, 0x4;    nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  sqrt_rsqrt D4, V2, 0x4;      nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  sin_cos D4, V2, 0x4;         nop
// CHECK: nop;    nop;    get_lut_entry_and_interval_start.bf16  log D4, V2, 0x4;         nop
