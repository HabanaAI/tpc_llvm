...
// CHECK: nop;    nop;    xor.f32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    xor.f32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    xor.f32  V5, V1, 0x3f4ccccd, SP0;       nop
...
// CHECK: nop;    nop;    xor.i32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    xor.i32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    xor.i32  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    xor.u32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    xor.u32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    xor.u32  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    xor.i16  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    xor.i16  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    xor.i16  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    xor.u16  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    xor.u16  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    xor.u16  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    xor.i8  V5, V1, V2, SP0;        nop
...
// CHECK: nop;    nop;    xor.i8  V5, V1, S2, SP0;        nop
...
// CHECK: nop;    nop;    xor.i8  V5, V1, 0x7b, SP0;      nop
...
// CHECK: nop;    nop;    xor.u8  V5, V1, V2, SP0;        nop
...
// CHECK: nop;    nop;    xor.u8  V5, V1, S2, SP0;        nop
...
// CHECK: nop;    nop;    xor.u8  V5, V1, 0x7b, SP0;      nop
