...
// CHECK: nop; 	nop; 	cmp_leq.f32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.f32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.f32  VP1, V2, 0x3f4ccccd; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.i8  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_leq.u8  VP1, V2, 0x7b; 	nop
