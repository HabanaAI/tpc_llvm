...
// CHECK: nop;    cmp_geq.f32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_geq.f32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_geq.f32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_geq.f32  SP1, S2, 0x3f4ccccd, SP0;   nop;    nop
...
// CHECK: nop;    cmp_geq.i32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_geq.i32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_geq.i32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_geq.i32  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_geq.u32  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_geq.u32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_geq.u32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_geq.u32  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_geq.i16  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_geq.i16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_geq.i16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_geq.i16  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_geq.u16  SP1, S2, S3, SP0;   nop;    nop
// CHECK: nop;    cmp_geq.u16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_geq.u16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_geq.u16  SP1, S2, 0x7b, SP0;         nop;    nop
...
// CHECK: nop;    cmp_geq.i8  SP1, S2, S3, SP0;    nop;    nop
// CHECK: nop;    cmp_geq.i8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_geq.i8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_geq.i8  SP1, S2, 0x7b, SP0;  nop;    nop
...
// CHECK: nop;    cmp_geq.u8  SP1, S2, S3, SP0;    nop;    nop
// CHECK: nop;    cmp_geq.u8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_geq.u8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_geq.u8  SP1, S2, 0x7b, SP0;  nop;    nop
