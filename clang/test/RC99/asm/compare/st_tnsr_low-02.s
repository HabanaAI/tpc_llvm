...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, VP4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, VP4
...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, VP4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, VP4
...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, VP4
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, VP4
...
NOP; NOP; NOP; ST_TNSR_LOW.RMW_SEL 0, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  0x0, I3, V4, S29
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  0x0, I3, V4, S29
...
NOP; NOP; NOP; ST_TNSR_LOW.RMW_SEL.PACK 0, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4, S29
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack 0x0, I3, V4, S29
...
NOP; NOP; NOP; ST_TNSR_LOW.RMW_SEL S28, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4, S29
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  S28, I3, V4, S29
...
NOP; NOP; NOP; ST_TNSR_LOW.RMW_SEL.PACK S28, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4, S29
// CHECK: nop; 	nop; 	nop; 	st_tnsr_low  pack S28, I3, V4, S29
