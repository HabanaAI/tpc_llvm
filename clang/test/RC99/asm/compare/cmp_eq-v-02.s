...
// CHECK: nop; 	nop; 	cmp_eq.f32 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.f32 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.f32 mask_eq_zero VP1, V2, 0x3f4ccccd; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i32 mask_eq_zero VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u32 mask_eq_zero VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i16 mask_eq_zero VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u16 mask_eq_zero VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.i8 mask_eq_zero VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8 mask_eq_zero VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8 mask_eq_zero VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_eq.u8 mask_eq_zero VP1, V2, 0x7b; 	nop
