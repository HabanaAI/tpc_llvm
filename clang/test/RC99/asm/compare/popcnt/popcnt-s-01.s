...
// CHECK: nop;    popcnt.f32 set=0 S1, S2;   nop;    nop
// CHECK: nop;    popcnt.f32 set=0 S1, S2, SP3;   nop;    nop
// CHECK: nop;    popcnt.f32 set=0 S1, S2, !SP3;  nop;    nop
// CHECK: nop;    popcnt.f32  set=1 S1, S2;  nop;    nop
...
// CHECK: nop;    popcnt.i32 set=0 S1, S2;   nop;    nop
// CHECK: nop;    popcnt.i32 set=0 S1, S2, SP3;   nop;    nop
// CHECK: nop;    popcnt.i32 set=0 S1, S2, !SP3;  nop;    nop
// CHECK: nop;    popcnt.i32  set=1 S1, S2;  nop;    nop
...
// CHECK: nop;    popcnt.u32 set=0 S1, S2;   nop;    nop
// CHECK: nop;    popcnt.u32 set=0 S1, S2, SP3;   nop;    nop
// CHECK: nop;    popcnt.u32 set=0 S1, S2, !SP3;  nop;    nop
// CHECK: nop;    popcnt.u32  set=1 S1, S2;  nop;    nop
...
// CHECK: nop;    popcnt.i16 set=0 S1, S2;   nop;    nop
// CHECK: nop;    popcnt.i16 set=0 S1, S2, SP3;   nop;    nop
// CHECK: nop;    popcnt.i16 set=0 S1, S2, !SP3;  nop;    nop
// CHECK: nop;    popcnt.i16  set=1 S1, S2;  nop;    nop
...
// CHECK: nop;    popcnt.u16 set=0 S1, S2;   nop;    nop
// CHECK: nop;    popcnt.u16 set=0 S1, S2, SP3;   nop;    nop
// CHECK: nop;    popcnt.u16 set=0 S1, S2, !SP3;  nop;    nop
// CHECK: nop;    popcnt.u16  set=1 S1, S2;  nop;    nop
...
// CHECK: nop;    popcnt.i8 set=0 S1, S2;    nop;    nop
// CHECK: nop;    popcnt.i8 set=0 S1, S2, SP3;    nop;    nop
// CHECK: nop;    popcnt.i8 set=0 S1, S2, !SP3;   nop;    nop
// CHECK: nop;    popcnt.i8  set=1 S1, S2;   nop;    nop
...
// CHECK: nop;    popcnt.u8 set=0 S1, S2;    nop;    nop
// CHECK: nop;    popcnt.u8 set=0 S1, S2, SP3;    nop;    nop
// CHECK: nop;    popcnt.u8 set=0 S1, S2, !SP3;   nop;    nop
// CHECK: nop;    popcnt.u8  set=1 S1, S2;   nop;    nop
