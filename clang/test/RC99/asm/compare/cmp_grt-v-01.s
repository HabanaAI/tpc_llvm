...
// CHECK: nop; 	nop; 	cmp_grt.f32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.f32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.f32  VP1, V2, 0x3f4ccccd; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u32  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u32  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u32  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u16  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u16  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u16  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.i8  VP1, V2, 0x7b; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u8  VP1, V2, V3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u8  VP1, V2, S3; 	nop
...
// CHECK: nop; 	nop; 	cmp_grt.u8  VP1, V2, 0x7b; 	nop
