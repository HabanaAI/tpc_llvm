...
// CHECK: nop;    cmp_eq.f32  SP1, S2, S3;   nop;    nop
// CHECK: nop;    cmp_eq.f32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_eq.f32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_eq.f32  SP1, S2, 0x3f4ccccd;   nop;    nop
...
// CHECK: nop;    cmp_eq.i32  SP1, S2, S3;   nop;    nop
// CHECK: nop;    cmp_eq.i32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_eq.i32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_eq.i32  SP1, S2, 0x7b;         nop;    nop
...
// CHECK: nop;    cmp_eq.u32  SP1, S2, S3;   nop;    nop
// CHECK: nop;    cmp_eq.u32  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_eq.u32  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_eq.u32  SP1, S2, 0x7b;         nop;    nop
...
// CHECK: nop;    cmp_eq.i16  SP1, S2, S3;   nop;    nop
// CHECK: nop;    cmp_eq.i16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_eq.i16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_eq.i16  SP1, S2, 0x7b;         nop;    nop
...
// CHECK: nop;    cmp_eq.u16  SP1, S2, S3;   nop;    nop
// CHECK: nop;    cmp_eq.u16  SP1, S2, S3, SP4;   nop;    nop
// CHECK: nop;    cmp_eq.u16  SP1, S2, S3, !SP4;  nop;    nop
// CHECK: nop;    cmp_eq.u16  SP1, S2, 0x7b;         nop;    nop
...
// CHECK: nop;    cmp_eq.i8  SP1, S2, S3;    nop;    nop
// CHECK: nop;    cmp_eq.i8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_eq.i8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_eq.i8  SP1, S2, 0x7b;  nop;    nop
...
// CHECK: nop;    cmp_eq.u8  SP1, S2, S3;    nop;    nop
// CHECK: nop;    cmp_eq.u8  SP1, S2, S3, SP4;    nop;    nop
// CHECK: nop;    cmp_eq.u8  SP1, S2, S3, !SP4;   nop;    nop
// CHECK: nop;    cmp_eq.u8  SP1, S2, 0x7b;  nop;    nop
