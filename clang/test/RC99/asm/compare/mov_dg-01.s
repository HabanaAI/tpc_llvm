...
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=1 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=2 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=3 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
...
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=0 dst=1 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=0 dst=2 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=0 dst=3 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x7b; 	nop
...
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x1 wr_ug=0x0 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x0 wr_ug=0x1 V1, V2, 0x7b; 	nop
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x1 wr_ug=0x1 V1, V2, 0x7b; 	nop
...
//CHECK: nop; 	nop; 	mov_dg src=0 dst=1 wr_lg=0x1 wr_ug=0x1 V1, V2, 0x7b; 	nop
...
//CHECK: nop; 	nop; 	mov_dg src=0 dst=0 wr_lg=0x0 wr_ug=0x0 V1, V2, 0x32; 	nop
