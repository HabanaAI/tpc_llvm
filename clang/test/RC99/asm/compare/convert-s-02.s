...
// CHECK: nop;    convert.f32  target_type=bf16 rhaz S0, S1, SP0;  nop;    nop
...
// CHECK: nop;    convert.i32  target_type=bf16 rhne S0, S1, SP0;  nop;    nop
...
// CHECK: nop;    convert.i16  target_type=bf16 rhne S0, S1, SP0;  nop;    nop
...
// CHECK: nop;    convert.u16  target_type=bf16 rhne S0, S1, SP0;  nop;    nop
...
// CHECK: nop;    convert.bf16 target_type=fp32  S0, S1, SP0;      nop;    nop
...
// CHECK: nop;    convert.bf16  target_type=int16 ru S0, S1, SP0;  nop;    nop
