...
// CHECK: nop;    nop;    and.f32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    and.f32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    and.f32  V5, V1, 0x3f4ccccd, SP0;       nop
...
// CHECK: nop;    nop;    and.i32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    and.i32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    and.i32  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    and.u32  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    and.u32  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    and.u32  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    and.i16  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    and.i16  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    and.i16  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    and.u16  V5, V1, V2, SP0;       nop
...
// CHECK: nop;    nop;    and.u16  V5, V1, S2, SP0;       nop
...
// CHECK: nop;    nop;    and.u16  V5, V1, 0x7b, SP0;     nop
...
// CHECK: nop;    nop;    and.i8  V5, V1, V2, SP0;        nop
...
// CHECK: nop;    nop;    and.i8  V5, V1, S2, SP0;        nop
...
// CHECK: nop;    nop;    and.i8  V5, V1, 0x7b, SP0;      nop
...
// CHECK: nop;    nop;    and.u8  V5, V1, V2, SP0;        nop
...
// CHECK: nop;    nop;    and.u8  V5, V1, S2, SP0;        nop
...
// CHECK: nop;    nop;    and.u8  V5, V1, 0x7b, SP0;      nop
