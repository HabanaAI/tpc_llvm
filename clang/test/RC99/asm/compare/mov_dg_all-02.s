...
// CHECK: nop; 	nop; 	mov_dg.all sdg0=0 sdg1=1 sdg2=2 sdg3=3 weg0=3 weg1=2 weg2=1 weg3=0 V2, V1, 0x7b, SP0; 	nop
// CHECK: nop; 	nop; 	mov_dg.all sdg0=1 sdg1=2 sdg2=3 sdg3=0 weg0=2 weg1=1 weg2=0 weg3=3 V2, V1, 0x7b, SP0; 	nop
// CHECK: nop; 	nop; 	mov_dg.all sdg0=2 sdg1=3 sdg2=0 sdg3=1 weg0=1 weg1=0 weg2=3 weg3=2 V2, V1, 0x7b, SP0; 	nop
// CHECK: nop; 	nop; 	mov_dg.all sdg0=3 sdg1=0 sdg2=1 sdg3=2 weg0=0 weg1=3 weg2=2 weg3=1 V2, V1, 0x7b, SP0; 	nop
...
// CHECK: nop; 	nop; 	mov_dg.all sdg0=0 sdg1=1 sdg2=2 sdg3=3 weg0=3 weg1=2 weg2=1 weg3=0 V2, V1, 0x32, SP0; 	nop
