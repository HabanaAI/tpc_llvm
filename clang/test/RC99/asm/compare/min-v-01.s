...
// CHECK: nop;    nop;    min.f32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    min.f32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    min.f32  V5, V1, 0x3f4ccccd;       nop
...
// CHECK: nop;    nop;    min.i32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    min.i32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    min.i32  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    min.u32  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    min.u32  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    min.u32  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    min.i16  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    min.i16  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    min.i16  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    min.u16  V5, V1, V2;       nop
...
// CHECK: nop;    nop;    min.u16  V5, V1, S2;       nop
...
// CHECK: nop;    nop;    min.u16  V5, V1, 0x7b;     nop
...
// CHECK: nop;    nop;    min.i8  V5, V1, V2;        nop
...
// CHECK: nop;    nop;    min.i8  V5, V1, S2;        nop
...
// CHECK: nop;    nop;    min.i8  V5, V1, 0x7b;      nop
...
// CHECK: nop;    nop;    min.u8  V5, V1, V2;        nop
...
// CHECK: nop;    nop;    min.u8  V5, V1, S2;        nop
...
// CHECK: nop;    nop;    min.u8  V5, V1, 0x7b;      nop
