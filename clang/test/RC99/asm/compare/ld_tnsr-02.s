...
// CHECK: ld_tnsr  V4, S27, I3, SP0;      nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, SP0;      nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, SP1;      nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, !SP1;     nop;    nop;    nop
// CHECK: ld_tnsr  VP4, S27, I3, SP0;     nop;    nop;    nop
// CHECK: ld_tnsr  VP4, S27, I3, SP0;     nop;    nop;    nop
...
// CHECK: ld_tnsr  V4, 0x0, I3, S30, SP0;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, 0x0, I3, S30, SP0;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, 0x0, I3, S30, SP1;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, 0x0, I3, S30, !SP1;        nop;    nop;    nop
// CHECK: ld_tnsr  VP4, 0x0, I3, S30, SP0;        nop;    nop;    nop
// CHECK: ld_tnsr  VP4, 0x0, I3, S30, SP0;        nop;    nop;    nop
...
// CHECK: ld_tnsr  V4, S27, I3, S30, SP0;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, S30, SP0;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, S30, SP1;         nop;    nop;    nop
// CHECK: ld_tnsr  V4, S27, I3, S30, !SP1;        nop;    nop;    nop
// CHECK: ld_tnsr  VP4, S27, I3, S30, SP0;        nop;    nop;    nop
// CHECK: ld_tnsr  VP4, S27, I3, S30, SP0;        nop;    nop;    nop
