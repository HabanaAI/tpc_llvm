...
// CHECK: nop;    nop;    nop;    st_l_v S1, V17, SP0
// CHECK: nop;    nop;    nop;    st_l_v S2, V18, SP0
// CHECK: nop;    nop;    nop;    st_l_v S3, V19, SP0
// CHECK: nop;    nop;    nop;    st_l_v S4, V20, SP0
// CHECK: nop;    nop;    nop;    st_l_v S5, V21, SP0
// CHECK: nop;    nop;    nop;    st_l_v S6, V22, SP0
// CHECK: nop;    nop;    nop;    st_l_v S7, V23, SP0


NOP; NOP; NOP; ST_L_V S35, V16, SP0
...
// CHECK: nop;    nop;    nop;    st_l_v S35, V16, SP0
...
// CHECK: nop;    nop;    nop;    st_l_v S34, VP7, SP0
// CHECK: nop;    nop;    nop;    st_l_v S33, VP8, SP0
// CHECK: nop;    nop;    nop;    st_l_v S32, VP9, SP0
// CHECK: nop;    nop;    nop;    st_l_v S31, VP0, SP0
// CHECK: nop;    nop;    nop;    st_l_v S30, VP1, SP0
// CHECK: nop;    nop;    nop;    st_l_v S29, VP2, SP0
// CHECK: nop;    nop;    nop;    st_l_v S28, VP3, SP0


NOP; NOP; NOP; ST_L_V S0, VP6, SP0
...
// CHECK: nop;    nop;    nop;    st_l_v S0, VP6, SP0
...
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V17, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V18, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V19, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V20, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V21, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V22, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, V23, SP0
...
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP7, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP8, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP9, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP0, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP1, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP2, SP0
// CHECK: nop;    nop;    nop;    st_l_v 0x7b, VP3, SP0
