...
// CHECK: nop;    nop;    convert.f32  target_type=int32 rz V0, V1;   nop
...
// CHECK: nop;    nop;    convert.f32  lane_sel=1 target_type=int16  V0, V1;  nop
...
// CHECK: nop;    nop;    convert.f32  lane_sel=3 target_type=int8 rhne V0, V1;       nop
...
// CHECK: nop;    nop;    convert.i32 target_type=fp32 rhne V0, V1;   nop
...
// CHECK: nop;    nop;    convert.i32  target_type=uint32  V0, V1;    nop
...
// CHECK: nop;    nop;    convert.i16 target_type=fp32  V0, V1;       nop
...
// CHECK: nop;    nop;    convert.i16  target_type=int32  V0, V1;     nop
...
// CHECK: nop;    nop;    convert.i16  target_type=uint32  V0, V1;    nop
...
// CHECK: nop;    nop;    convert.i16  target_type=uint16  V0, V1;    nop
...
// CHECK: nop;    nop;    convert.i16  lane_sel=1 target_type=uint8  V0, V1;  nop
...
// CHECK: nop;    nop;    convert.i8 target_type=fp32  V0, V1;        nop
...
// CHECK: nop;    nop;    convert.i8  target_type=int32  V0, V1;      nop
...
// CHECK: nop;    nop;    convert.i8  target_type=uint32  V0, V1;     nop
...
// CHECK: nop;    nop;    convert.i8  target_type=int16  V0, V1;      nop
...
// CHECK: nop;    nop;    convert.i8  target_type=uint16  V0, V1;     nop
...
// CHECK: nop;    nop;    convert.i8  target_type=uint8  V0, V1;      nop
