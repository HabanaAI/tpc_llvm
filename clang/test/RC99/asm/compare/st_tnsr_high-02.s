...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, SP0
...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, SP0
...
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, SP0
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL 0, I3, VP4, S29
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL 0, I3, VP4, S29, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL 0, I3, VP4, S29, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL 0, I3, VP4, S29, !SP1

// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, V4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, VP4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  0x0, I3, VP4, S29, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, S29
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, S29, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, S29, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, S29, !SP1

// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack 0x0, I3, VP4, S29, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH 0, I3, VP4, S29
NOP; NOP; NOP; ST_TNSR_HIGH 0, I3, VP4, S29, SP0
NOP; NOP; NOP; ST_TNSR_HIGH 0, I3, VP4, S29, SP1
NOP; NOP; NOP; ST_TNSR_HIGH 0, I3, VP4, S29, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.PACK 0, I3, VP4, S29
NOP; NOP; NOP; ST_TNSR_HIGH.PACK 0, I3, VP4, S29, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.PACK 0, I3, VP4, S29, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.PACK 0, I3, VP4, S29, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL  0, I3, VP4
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL  0, I3, VP4,  SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL  0, I3, VP4,  SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL  0, I3, VP4,  !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK 0, I3, VP4, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL S28, I3, VP4, S29
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL S28, I3, VP4, S29, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL S28, I3, VP4, S29, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL S28, I3, VP4, S29, !SP1

// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  S28, I3, VP4, S29, !SP1
...
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK S28, I3, VP4
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK S28, I3, VP4, SP0
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK S28, I3, VP4, SP1
NOP; NOP; NOP; ST_TNSR_HIGH.RMW_SEL.PACK S28, I3, VP4, !SP1

// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, V4, S29, !SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, S29, SP0
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, S29, SP1
// CHECK: nop; 	nop; 	nop; 	st_tnsr_high  pack S28, I3, VP4, S29, !SP1
