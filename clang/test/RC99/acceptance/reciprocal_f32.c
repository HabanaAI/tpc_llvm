...
//    float64  v1 = v_f32_form_fp_num_s_v_v_vb(*((float*)&unit_val),input,input,false,true,false,false,false,all_true_pred,0 );
    float64  v1 = v_f32_form_fp_num_s_v_v_vb(*((float*)&unit_val),input,input,0x8,all_true_pred,0 );
...
//    float64_pair_t pairv2v3 =  v_f32_get_lut_entry_and_interval_start_v_b(v1,0/*significant shift*/,/*e_func_variant_default*/0,1,0);
    uchar256_float64_pair_t pairv2v3 =  v_f32_get_lut_entry_and_interval_start_v_b(v1,0/*significant shift*/,/*e_func_variant_default*/0,1,0);
    //GET_LUT_ENTRY_AND_INTERVAL_START.F32 V2, V3, V1, 16, 0
    pairv2v3 = v_f32_get_lut_entry_and_interval_start_v_b(v1,16,0,1,0);
...
//    float64_pair_t pairv4v5 = v_f32_lookup_c1c2_v_b(pairv2v3.v1, 0 /*e_lookup_fp32*/,0/* e_reciprocal*/ ,1,0 );
    float64_pair_t pairv4v5 = v_f32_lookup_c1c2_v_b(*((float64*)&pairv2v3.v1), 0 /*e_lookup_fp32*/,0/* e_reciprocal*/ ,1,0 );
    //SUB.F32 V3, V1, V3
...
//    float64 v5 = v_f32_lookup_c0_v_b(pairv2v3.v1,0 /*e_lookup_fp32*/,0 /* e_reciprocal */,1,0 );
    float64 v5 = v_f32_lookup_c0_v_b(*((float64*)&pairv2v3.v1),0 /*e_lookup_fp32*/,0 /* e_reciprocal */,1,0 );
    // MAC.F32 V4, V3, V5

    // GAUDI-164
    pairv2v3.v2 = v_f32_mac_v_v_b(pairv2v3.v2, v5, pairv2v3.v2, false,1,0);
...
//    v5 = v_f32_mac_v_v_b(pairv2v3.v2 , pairv4v5.v1, v5,false,1,0);
    ...
    bool256 vp1 = bv_u32_cmp_leq_v_v_vb(a2,BIASED_EXP_0_SHIFTED,all_true_pred,0);
...
//    float64 result = v_f32_form_fp_num_v_v_v_b(*((float64*)&(a2)),input,v5,true /*exp_bias*/,false,false,false,false,1,0);
    float64 result = v_f32_form_fp_num_v_v_v_b(*((float64*)&(a2)),input,v5,0x10, /*exp_bias,false,false,false,false, */1,0);
    //MOV.F32 V2, f32_0, VP1 - MOV is implemented with ADD (X + 0 )
    result = v_f32_add_v_s_vb(result,0,vp1,0);
    // ABS.F32 V11, V10
//    float64 v11 = v_f32_abs_v_b(result,1,0);
    ...
    v1 = *((float64*) &v1_uint);
    result = v_f32_f32_sel_less_v_v_v_v_vb(v11,FLT_MIN,v1,result,all_true_pred,1);
    //SEL_EQ.U32 V2, V11, $PLUS_INF_FP32$, V0, V2
    uint64 result2 = v_u32_u32_sel_eq_v_v_v_v_vb(*((uint64*)&(v11)),PLUS_INF_FP32,v0,*((uint64*)&(result)),all_true_pred,1);
    //cast back to float
    result = *((float64*)&(result2));
    //SEL_EQ.F32 V2, V10, V10, V2, $NAN_FP32$
    uint64 Nan = 0x7fffffff;
    result =  v_f32_f32_sel_eq_v_v_v_v_vb(input,input,result, *((float64*)&(Nan)),all_true_pred,1);
...
void main(tensor input, tensor output)
{
    int5 addr=  0; 
    // spatial for loops
    float64 tmp = v_f32_ld_tnsr_i_b(addr,input,1,0);
