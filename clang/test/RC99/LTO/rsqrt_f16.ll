...
entry:
  ...
  %1 = tail call <128 x half>  @llvm.tpc.rsqrt.v128f16(<128 x half> %0)
  tail call void @llvm.tpc.st.tnsr.v128f16(<5 x i32> zeroinitializer, i8 1, <128 x half> %1, i32 0, i1 true, i1 false)
  ret void
  ; CHECK: calc_fp_special.f16 func=rsqrt %V0, %V5, %V5
}
declare <128 x half>  @llvm.tpc.rsqrt.v128f16(<128 x half>)
