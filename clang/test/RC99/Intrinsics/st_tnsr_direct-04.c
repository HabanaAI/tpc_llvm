...
void main(unsigned addr1, unsigned addr2, int dest, _Bool pred) {
  int64 __local *vector_ptr = (int64 __local *)dest;
  {
    float64 __local *dest_ptr = (float64 __local *)vector_ptr;
    float64 res = 0;
    
    v_f32_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    int64 __local *dest_ptr = (int64 __local *)vector_ptr;
    int64 res = 0;

    v_i32_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_u32_st_tnsr_direct(addr1 + 1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_i16_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_u16_st_tnsr_direct(addr1 + 1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_i8_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_u8_st_tnsr_direct(addr1 + 1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_i1_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %VP{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    half128 __local *dest_ptr = (half128 __local *)vector_ptr;
    half128 res = 0;
    
    v_f16_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    ...
    v_i32_st_tnsr_direct(addr1, addr2, res, SW_PCK_32_TO_8, pred, 0);
    *dest_ptr++ = res;
    vector_ptr = (int64 __local *)dest_ptr;
    // CHECK-DAG: st_tnsr PCK_32_TO_8 direct %S{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
  }
  {
    int64 __local *dest_ptr = (int64 __local *)vector_ptr;
    int64 res = 0;
  ...
  }
  {
    ...
    v_f8_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
  ...
  }
  {
    ...
    v_h8_st_tnsr_direct(addr1, addr2, res, 0, pred, 0);
    *dest_ptr++ = res;
