...
void main(int dest, int src1, int src2, int pred_val, int vect_pred,
  ...
  if (dest > 13) {
    ...
    result = v_f8_sel2_less_f8_b(x1, x2, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_f8_b(x1, af8, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]    

    result = v_f8_sel2_less_f8_b(x1, (minifloat)1.5, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]   

    result = v_f8_sel2_less_f8_b(x1, x2, x3, af8, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_f8_b(x1, x2, x3, (minifloat)1.5, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[SPRED]]

    //------ v_f8_sel2_less_f8_vb

    result = v_f8_sel2_less_f8_vb(x1, x2, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_f8_vb(x1, af8, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]    

    result = v_f8_sel2_less_f8_vb(x1, (minifloat)1.5, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]   

    result = v_f8_sel2_less_f8_vb(x1, x2, x3, af8, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_f8_vb(x1, x2, x3, (minifloat)1.5, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_143  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[VPRED]]
   ...
   result = v_f8_sel2_less_h8_b(x1, x2, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]     
    result = v_f8_sel2_less_h8_b(x1, ah8, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]    

    result = v_f8_sel2_less_h8_b(x1, (minihalf)1.5, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x3e, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]   

    result = v_f8_sel2_less_h8_b(x1, x2, x3, af8, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_h8_b(x1, x2, x3, (minifloat)1.5, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[SPRED]]

    //------ v_f8_sel2_less_h8_vb

    result = v_f8_sel2_less_h8_vb(x1, x2, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_h8_vb(x1, ah8, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]    

    result = v_f8_sel2_less_h8_vb(x1, (minihalf)1.5, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x3e, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]   

    result = v_f8_sel2_less_h8_vb(x1, x2, x3, af8, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_h8_vb(x1, x2, x3, (minifloat)1.5, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.f8_152  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[VPRED]]
    dest_ptr = (int64_int64 __local *)dptr;
    src_ptr = (int64 __local *)sptr;
    res_ptr = (int64 __local *)rptr;
    }
  if (dest > 15) {
    ...
    result = v_f8_sel2_less_i8_b(x1, x2, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_i8_b(x1, ai16, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]    

    result = v_f8_sel2_less_i8_b(x1, 123, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x7b, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]   

    result = v_f8_sel2_less_i8_b(x1, x2, x3, af8, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_i8_b(x1, x2, x3, (minifloat)1.5, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[SPRED]]

    //------ v_f8_sel2_less_i8_vb

    result = v_f8_sel2_less_i8_vb(x1, x2, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_i8_vb(x1, ai16, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]    

    result = v_f8_sel2_less_i8_vb(x1, 123, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x7b, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]   

    result = v_f8_sel2_less_i8_vb(x1, x2, x3, af8, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_i8_vb(x1, x2, x3, (minifloat)1.5, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.i8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[VPRED]]
  ...
  if (dest > 16) {
    ...
    result = v_f8_sel2_less_u8_b(x1, x2, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_u8_b(x1, au16, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]    

    result = v_f8_sel2_less_u8_b(x1, 123, x3, x4, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x7b, %V{{[0-9]+}}, %V{{[0-9]+}}, [[SPRED]]   

    result = v_f8_sel2_less_u8_b(x1, x2, x3, af8, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[SPRED]]     

    result = v_f8_sel2_less_u8_b(x1, x2, x3, (minifloat)1.5, 0, result, spred, 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[SPRED]]

    //------ v_f8_sel2_less_u8_vb

    result = v_f8_sel2_less_u8_vb(x1, x2, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_u8_vb(x1, au16, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]    

    result = v_f8_sel2_less_u8_vb(x1, 123, x3, x4, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, 0x7b, %V{{[0-9]+}}, %V{{[0-9]+}}, [[VPRED]]   

    result = v_f8_sel2_less_u8_vb(x1, x2, x3, af8, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %S{{[0-9]+}}, [[VPRED]]     

    result = v_f8_sel2_less_u8_vb(x1, x2, x3, (minifloat)1.5, 0, result, (vpred), 0);
    *dptr++ = result;
    // CHECK: sel2_less.u8  %D{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, 0x3c, [[VPRED]]
