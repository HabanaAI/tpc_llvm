...
void main(int x0, int x1, int x2, int x4, int dest0)
{
   ...
   minifloat256 __local *res0 = (minifloat256  __local *)dest0;
    ...
    temp_res0 = v_f8_form_fp_num_b(*ptr_x0, *ptr_x1, *ptr_x2, SW_ADD_BIAS, temp_res0, x4, 0);
    *res0 = temp_res0;
}
//CHECK-ASM: .globl main
//CHECK-ASM-DAG: form_fp_num.f8_143 exp_add_bias %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, %SP{{[0-9]+}}
