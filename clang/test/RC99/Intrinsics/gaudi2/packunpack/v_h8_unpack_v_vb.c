...
void main(int x0, int dest0)
{
    ...
    temp_res0 = v_h8_unpack_vb(*ptr_x0, ((1) << 8) | ((1) << 9) | ((1) << 10), temp_res0, (pred4), 0);
    *res0 = temp_res0;
}
//CHECK-ASM: .globl main
//CHECK-ASM-DAG: unpack.f8_152  source_group=1 element_stride=4 group_half=1 %V{{[0-9]+}}, %V{{[0-9]+}}, %VP{{[0-9]+}}
