...
void main(int x0, int dest0)
{
    ...
    bool256 pred3;
    pred3 =  v_i1_mov_i1_b(1, 0, (bool256){0}, 1, 0);
    
   minihalf256 __local *res0 = (minihalf256  __local *)dest0;
    minihalf256 temp_res0 = 0;
    temp_res0 = v_h8_pack_vb(*ptr_x0, ((1) << 8) | ((1) << 9), temp_res0, (pred3), 0);
    *res0 = temp_res0;
}
//CHECK-ASM: .globl main
//CHECK-ASM-DAG: pack.f8_152 source_group=1 element_stride=4 %V{{[0-9]+}}, %V{{[0-9]+}}, %VP{{[0-9]+}}
