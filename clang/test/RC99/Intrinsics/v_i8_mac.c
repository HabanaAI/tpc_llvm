...
void main(int x0a, int x1a, char xs, int dest, _Bool pred, int vpreda) {
  ...
  *dptr++ = res;
  // CHECK: mac.i8 %A{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}

  res = v_i8_mac_b(x0, x1, res, SW_SAT, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}
  ...
  *dptr++ = res;
  // CHECK: mac.i8 %A{{[0-9]+}}, %V{{[0-9]+}}, %S2

  res = v_i8_mac_b(x0, xs, res, SW_SAT, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %S2
  ...
  *dptr++ = res;
  // CHECK: mac.i8 %A{{[0-9]+}}, %V{{[0-9]+}}, 0x7b

  res = v_i8_mac_b(x0, 123, res, SW_SAT, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, 0x7b
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, x1, res, 1, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, x1, res, 1, pred, 1);
  *dptr++ = res;
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_vb(x0, x1, res, 1, vpred, 1);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %V{{[0-9]+}}, !%VP{{[0-9]+}}
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, xs, res, 1, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %S2
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, xs, res, 1, pred, 1);
  *dptr++ = res;
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_vb(x0, xs, res, 1, vpred, 1);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, %S2, !%VP{{[0-9]+}}
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, 123, res, 1, 1, 0);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, 0x7b
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_b(x0, 123, res, 1, pred, 1);
  *dptr++ = res;
  ...
  *dptr++ = res;
  ...
  res = v_i8_mac_vb(x0, 123, res, 1, vpred, 1);
  *dptr++ = res;
  // CHECK: mac.i8 st %A{{[0-9]+}}, %V{{[0-9]+}}, 0x7b, !%VP{{[0-9]+}}
}
