...
void main(int src1, tensor out) {
  float f = s_convert_i32_to_f32(src1,SW_CLIP_FP,0.0, 1,0);
     int5 cq = {0,0,0,0,0};
     s_f32_st_g(gen_addr(cq, out, 0, 0, 1, 0), f, 0, 1, 0);
}
// DIS:  convert.i32 target_type=fp32 rhne clip_fp
