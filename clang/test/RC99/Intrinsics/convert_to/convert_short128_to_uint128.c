...
void main(int src, int dest) {
  ...
  *dptr = convert_short128_to_uint128(src_val, 0);
}

// CHECK-IR: call <128 x i32> @llvm.tpc.convert.v128i32.v128i16.i1(<128 x i16> {{.*}}, i8 7, i32 768, <128 x i32> undef, i1 true, i1 false)
