...
// This is failure_struct_with_constant_loop2.c from GAUDI-255 attachments.
...
void main(tensor ifm, tensor ofm_val, tensor ofm_index, char firstActivation, char lastActivation)  
{
    ...
    {     
        ...
        v_u8_st_tnsr(ofmIndxCord, ofm_index, sorted_uchar[0].v1, 0, 1, 0);
