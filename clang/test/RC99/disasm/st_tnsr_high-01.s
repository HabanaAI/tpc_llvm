...
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x0, I31, V0, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x1, I30, V1, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x2, I29, V2, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x3, I28, V3, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x4, I3, V39, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x5, I2, V38, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x6, I1, V37, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x7, I0, V36, SP0
...
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x0, I31, VP0, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x1, I30, VP1, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x2, I29, VP2, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x3, I28, VP3, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x4, I3, VP12, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x5, I2, VP13, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x6, I1, VP14, SP0
// CHECK: nop;    nop;    nop;    st_tnsr_high  0x7, I0, VP15, SP0
