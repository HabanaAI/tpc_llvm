...
void main(int x0, int x2, int x3, int dest0, int dest1, int dest2, int dest3, int dest4) {
  ...
  temp_res1 = v_f32_lookup_1c_v_b(*ptr_x1, temp_res0, 0, e_bf16_tanh, x3, 0);
  temp_res2 = v_f32_lookup_1c_v_b(*ptr_x1, temp_res0, 1, e_bf16_rcp_scalar, x3, 0);
  temp_res3 = v_f32_lookup_1c_v_b(*ptr_x1, temp_res0, 1, e_bf16_rcp_scalar, x3, 0);
  temp_res4 = v_f32_lookup_1c_v_b(*ptr_x1, temp_res0, 1, e_bf16_sqrt_poly2_m4_c0, x3, 0);
